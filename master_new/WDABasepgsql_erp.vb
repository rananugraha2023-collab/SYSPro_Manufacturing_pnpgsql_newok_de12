...
Public Class WDABasepgsql_erp
    ...
    Public Sub New(ByVal Company As String, ByVal Application As String)
        'Connection = New nPgSqlConnection("Server=192.50.1.3;Port=5432;User Id=postgres;Password=syspronuri;Database=mfgpro")
        Connection = New nPgSqlConnection("Server=localhost;Port=5432;User Id=postgres;Password=syspronuri;Database=mfgpro")
    End Sub
