...
Public Class WDABasepgsql_local
    ...
    Public Sub New(ByVal Company As String, ByVal Application As String)
        'Connection = New nPgSqlConnection("Server=localhost;Port=5432;User Id=postgres;Password=syspronuri;Database=sdm")
        Connection = New NpgsqlConnection("Server=10.1.1.36;Port=5432;User Id=postgres;Password=syspronuri;Database=sdm")
    End Sub
