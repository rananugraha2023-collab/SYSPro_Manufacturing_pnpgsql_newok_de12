...
Public Class FItemInternalPriceCost
    ...
    Public Overrides Function insert() As Boolean
        ...
        Dim _ip_oid As Guid = Guid.NewGuid
        Try
                ...
                With objinsert
                    ...
                    Try
                        ...
                        .Command.CommandText = "INSERT INTO  " _
                                            ...
                                            & ")  " _
                                            & "VALUES ( " _
                                            & SetSetring(_ip_oid.ToString) & ",  " _
                                            & SetInteger(master_new.ClsVar.sdom_id) & ",  " _
                                            & SetInteger(ip_si_id.EditValue) & ",  " _
                                            & SetDate(ip_date.DateTime) & ",  " _
                                            & SetInteger(ip_en_id.EditValue) & ",  " _
                                            & SetInteger(ip_cust_id.EditValue) & ",  " _
                                            & SetBitYN(ce_ip_is_internal.EditValue) & ",  " _
                                            & SetBitYN(ce_ip_best.EditValue) & ",  " _
                                            & SetInteger(ip_pt_id.Tag) & ",  " _
                                            & SetInteger(ip_vendor_id.Tag) & ",  " _
                                            & SetDbl(ip_cost.EditValue) & ",  " _
                                            & SetDbl(ip_margin_pct.EditValue) & ",  " _
                                            & SetDbl(ip_price.EditValue) & ",  " _
                                            & SetDate(ip_start_date.DateTime) & ",  " _
                                            & SetDate(ip_end_date.DateTime) & ",  " _
                                            & SetBitYN(ce_ip_active.EditValue) & ",  " _
                        ...
                        after_success()
                        set_row(_ip_oid.ToString, "ip_oid")
                        insert = True
    ...
    Private Sub ip_price_EditValueChanged(sender As Object, e As EventArgs) Handles ip_price.EditValueChanged
