...
Public Class FRecieveQRCodePrint
    ...
    Private Sub FRecieveQRCodePrint_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        form_first_load()
    End Sub
    ...
    Public Overrides Sub insert_data_awal()
        ...
        invqr_req_id.Text = ""
        'invqr_pi_desc.Text = ""
        invqr_seq_from.EditValue = 0.0
        invqr_seq_to.EditValue = 0.0
        _pt_id = -1
                ...
                With objinsert
                    ...
                    Try
                        ...
                        .Command.CommandText = "INSERT INTO  " _
                                            ...
                                            & SetSetring(_pt_id) & ",  " _
                                            & SetInteger(_pi_id) & ",  " _
                                            & SetDbl(invqr_seq_from.EditValue) & ",  " _
                                            & SetDbl(invqr_seq_to.EditValue) & ",  " _
    ...
    Public Overrides Function edit_data() As Boolean
        If MyBase.edit_data = True Then
            ...
            With ds.Tables(0).Rows(row)
                ...
                invqr_req_id.EditValue = .Item("invqr_pi_id")
                'invqr_req_desc.EditValue = .Item("invqr_pt_id")
                invqr_en_id.EditValue = .Item("invqr_en_id")
                invqr_seq_from.EditValue = .Item("invqr_price1")
                invqr_seq_to.EditValue = .Item("invqr_price2")
                ...
                With objinsert
                    ...
                    Try
                        ...
                        .Command.CommandText = "UPDATE  " _
                                            ...
                                            & "  invqr_price1 = " & SetDec(invqr_seq_from.EditValue) & ",  " _
                                            & "  invqr_price2 = " & SetDec(invqr_seq_to.EditValue) & ",  " _
                                            & "  invqr_si_id = " & SetInteger(invqr_si_id.EditValue) & "  " _
                                            & "  " _
                                            & "WHERE  " _
    ...
    Private Sub invqr_req_id_ButtonClick(ByVal sender As Object, ByVal e As DevExpress.XtraEditors.Controls.ButtonPressedEventArgs) Handles invqr_req_id.ButtonClick, invqr_req_id.ButtonClick
        Dim frm As New FPurchaseReceiptSearch()
        frm.set_win(Me)
        frm._en_id = invqr_en_id.EditValue
        'frm._pi_id = invqr_pi_id.EditValue
        frm._obj = invqr_req_id
