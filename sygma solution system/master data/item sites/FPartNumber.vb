...
Public Class FPartNumber
    ...
    Public Overrides Sub load_cb_en()
        ...
        dt_bantu = New DataTable
        dt_bantu = func_data.load_methode_mstr()
        With pt_methode_id
            .Properties.DataSource = dt_bantu
            .Properties.DisplayMember = dt_bantu.Columns("code_name").ToString
            .Properties.ValueMember = dt_bantu.Columns("code_id").ToString
    ...
    Public Overrides Sub format_grid()
        ...
        add_column_copy(gv_master, "Man Methode", "pt_methode_name", DevExpress.Utils.HorzAlignment.Default)
    ...
    Public Overrides Function get_sequel() As String
        get_sequel = "SELECT  distinct " _
                    ...
                    & "  ptnr_man_methode_mstr.code_name as pt_methode_name, pt_methode_id " _
                    & "FROM  " _
                    & "  public.pt_mstr" _
                    ...
                    & " left outer join code_mstr ptnr_man_methode_mstr on ptnr_man_methode_mstr.code_id = pt_methode_id " _
                ...
                With objinsert
                    ...
                    Try
                        ...
                        .Command.CommandText = "INSERT INTO  " _
                                            ...
                                            & "  pt_price, " _
                                            & "  pt_writer_id, " _
                                            & "  pt_class,pt_approval_status,pt_phantom,pt_methode_id, " _
                                            & "  pt_dt " _
                                            & ")  " _
                                            & "VALUES ( " _
                                            ...
                                            & SetInteger(pt_methode_id.EditValue) & ",  " _
    ...
    Public Overrides Function edit_data() As Boolean
        If MyBase.edit_data = True Then
            ...
            With ds.Tables(0).Rows(row)
                ...
                If IsDBNull(.Item("pt_methode_id")) = True Then
                    pt_tax_class.ItemIndex = 0
                Else
                    pt_methode_id.EditValue = .Item("pt_methode_id")
                End If
                ...
                With objinsert
                    ...
                    Try
                        ...
                        .Command.CommandText = "UPDATE  " _
                                            ...
                                            & "  pt_methode_id = " & SetSetring(pt_methode_id.EditValue) & ",  " _
