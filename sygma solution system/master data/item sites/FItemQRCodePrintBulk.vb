...
Public Class FItemQRCodePrintBulk
    ...
    Private Sub FItemQRCodePrintBulk_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        form_first_load()
    End Sub
    ...
    Public Overrides Sub format_grid()
        ...
        add_column_copy(gv_master, "QR Code", "invqr_qr_code", DevExpress.Utils.HorzAlignment.Default)
