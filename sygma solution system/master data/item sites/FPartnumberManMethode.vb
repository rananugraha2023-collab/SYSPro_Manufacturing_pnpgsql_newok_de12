Public Class FPartnumberManMethode


    Private Sub FLocationType_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        form_first_load()
        _code_field = "ptnr_man_methode_mstr"
    End Sub
    ...
    Public Overrides Sub format_grid()
        ...
        add_column_copy(gv_master, "Is Consignment", "code_usr_1", DevExpress.Utils.HorzAlignment.Default)
