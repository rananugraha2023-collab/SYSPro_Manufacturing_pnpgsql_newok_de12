...
Public Class FCanvasingPlanning
    ...
    Private Sub FCanvasingPlanning_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        form_first_load()
    ...
    Public Overrides Sub format_grid()
        ...
        add_column(gv_edit_item, "Location", "pt_code", DevExpress.Utils.HorzAlignment.Default)
        add_column(gv_edit_item, "Qty", "pt_desc2", DevExpress.Utils.HorzAlignment.Default)
        add_column(gv_edit_item, "Unit Measure", "pt_desc2", DevExpress.Utils.HorzAlignment.Default)
                ...
                With objinsert
                    ...
                    Try
                        ...
                        .Command.CommandText = "INSERT INTO  " _
                                            ...
                                            & SetInteger(cnv_sales_program.EditValue) & ",  " _
                ...
                Using objcb As New master_new.WDABasepgsql("", "")
                    With objcb
                        .SQL = "SELECT  " _
                            ...
                            & "  where cnv_oid = '" + ds.Tables(0).Rows(BindingContext(ds.Tables(0)).Position).Item("cnv_oid").ToString + "'"
