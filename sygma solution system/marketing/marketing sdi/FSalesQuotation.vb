...
Public Class FSalesQuotation
    ...
    Public Overrides Sub format_grid()
        ...
        add_column_copy(gv_master, "Affiliate Fee", "sq_affiliate_fee", DevExpress.Utils.HorzAlignment.Far, DevExpress.Utils.FormatType.Numeric, "n")
        add_column_copy(gv_master, "Cashback", "sq_cashback", DevExpress.Utils.HorzAlignment.Far, DevExpress.Utils.FormatType.Numeric, "n")
        ...
        add_column_copy(gv_detail, "Cashback", "sqd_cashback", DevExpress.Utils.HorzAlignment.Far, DevExpress.Utils.FormatType.Numeric, "n")
