...
Public Class FSalesQuotationConsCanvasing
    ...
    Private Sub FSalesQuotationConsCanvasing_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
    ...
    Public Overrides Sub format_grid()
        ...
        'sq_ajb_code
        add_column_copy(gv_master, "AJB Number", "sq_ajb_code", DevExpress.Utils.HorzAlignment.Default)
    ...
    Public Overrides Function get_sequel() As String
        get_sequel = "SELECT  " _
                    ...
                    & "  sq_ar_cc_id, " _
                    & "  sq_dp, " _
                    & "  sq_disc_header, sq_payment_date," _
                    & "  sq_total, " _
                    & "  sq_print_count, " _
                    & "  sq_need_date, " _
                    & "  sq_cons, " _
                    ...
                    & "  en_mstr.en_desc,en_mstr_shipment.en_desc as en_desc_shipment, " _
                    & "  ptnr_mstr_sold.ptnr_name as ptnr_name_sold,ptnr_mstr_sold.ptnr_customer_id as ptnr_customer_id, " _
                    ...
                    & "  cc_mstr_ar.cc_desc,sq_ajb_code, " _
                    & "  cu_name, " _
                    & "  tran_name,sq_sales_program,sq_status_produk,sq_diskon_produk,sq_unique_code, sq_dp_unique,sq_payment_unique, ptnra_receiver_name,sq_ptnra_id,ptnra_customer_id, " _
                    ...
                    & "  left outer join ptnra_addr on (sq_ptnra_id =  ptnra_id  and ptnra_ptnr_oid=ptnr_mstr_sold.ptnr_oid ) " _
                    ...
                    & "  left outer join en_mstr en_mstr_shipment on sq_en_id_shipment = en_mstr_shipment.en_id " _
                    & " where sq_cons='N'"

        If CePaymentDate.Checked = False Then
            get_sequel = get_sequel & " and  sq_date >= " + SetDate(pr_txttglawal.DateTime.Date) _
                    & " and sq_date <= " + SetDate(pr_txttglakhir.DateTime.Date)
        Else
            get_sequel = get_sequel & " and  sq_payment_date >= " + SetDate(pr_txttglawal.DateTime.Date) _
                   & " and sq_date <= " + SetDate(pr_txttglakhir.DateTime.Date)
        End If
...
#End Region
    ...
    Public Overrides Function edit_data() As Boolean
        ...
        If MyBase.edit_data = True Then
            ...
            With ds.Tables(0).Rows(row)
                ...
                sq_cnv_code.Text = SetString(.Item("sq_cnv_code"))
                _sq_cnv_oid = SetString(.Item("sq_cnv_oid"))
    ...
    Private Sub sq_cnv_code_ButtonClick(ByVal sender As Object, ByVal e As DevExpress.XtraEditors.Controls.ButtonPressedEventArgs) Handles sq_cnv_code.ButtonClick
        'If func_coll.get_conf_file("ref_po_sales_order") = "1" Then
        '    If _sq_ptnr_id_sold_mstr = -1 Then
        '        MessageBox.Show("Please Specipy Customer Data Before..", "Error", MessageBoxButtons.OK, MessageBoxIcon.Error)
        '    Else
        Dim frm As New FCanvasingSearch()
        frm.set_win(Me)
        frm._obj = sq_cnv_code
        frm._sq_sales_person = sq_sales_person.EditValue
        frm.type_form = True
        frm.ShowDialog()
        '    End If
        'End If
