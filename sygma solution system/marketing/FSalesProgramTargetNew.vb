...
Public Class FSalesProgramTargetNew
    ...
    Private Sub FSalesProgramTargetNew_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        form_first_load()

        sls_date.EditValue = DateTime.Now
    End Sub
    ...
    Public Overrides Sub format_grid()
        ...
        add_column_copy(gv_detail_cust, "Customer Code", "ptnr_code", DevExpress.Utils.HorzAlignment.Default)
        add_column_copy(gv_detail_cust, "Customer Name", "ptnr_name", DevExpress.Utils.HorzAlignment.Default)
        add_column_copy(gv_detail_cust, "Amount/Qty", "plansd_amount", DevExpress.Utils.HorzAlignment.Far, DevExpress.Utils.FormatType.Numeric, "n")
    ...
    Public Overrides Function get_sequel() As String
        ...
        get_sequel = "SELECT  " _
                ...
                & "  a.sls_roi, " _
                & "  a.sls_target_qty, " _
                & "  a.sls_target_value, " _
                & "  a.sls_achieved_qty, " _
                & "  a.sls_achieved_value, " _
                & "  a.sls_remarks, " _
                & "  a.sls_tran_id, " _
                & "  a.sls_status " _
                & "FROM " _
                & "  public.sls_program a " _
                & "  LEFT OUTER JOIN public.sls_event_mstr b ON (a.sls_event_id = b.event_id) " _
                & "  LEFT OUTER JOIN public.pi_mstr c ON (a.sls_pi_id = c.pi_id)"
    ...
    Public Overrides Sub insert_data_awal()
        ...
        sls_event_id.Tag = ""
        sls_event_id.EditValue = ""

        sls_pi_id.Tag = ""
        sls_pi_id.EditValue = ""

        sls_start_date.DateTime = Now
        sls_start_date.Enabled = True

        sls_end_date.DateTime = Now
        sls_end_date.Enabled = True

        sls_cost.Text = ""
        sls_roi.Text = ""
        sls_target_qty.Text = ""
        sls_target_value.Text = ""
        sls_achieved_qty.Text = ""
        sls_achieved_value.Text = ""
        sls_remarks.Text = ""
        sls_tran_id.ItemIndex = 0
        sls_status.ItemIndex = 0
        sls_stackable.EditValue = False
        sls_active.EditValue = False

        
        'plans_qrtr_id.ItemIndex = 0

        'sls_date.DateTime = Now
        'sls_date.Enabled = True
    ...
    Public Overrides Function insert() As Boolean
        ...
        '_code = GetNewNumberYM("sls_progran", "sls_code", 5, "SLP" & sls_en_id.GetColumnValue("en_code") _
        '                             & CekTanggal.ToString("yyMM") & master_new.ClsVar.sServerCode, True)

        _code = GetNewNumberYM("sls_progran", "sls_code", 5, "SLP" _
                                     & CekTanggal.ToString("yyMM") & master_new.ClsVar.sServerCode, True)
                ...
                With objinsert
                    ...
                    Try
                        ...
                        .Command.CommandText = "INSERT INTO  " _
                                        ...
                                        & SetSetring(_code) & ",  " _
                                        & SetDateNTime00(sls_date.EditValue) & ",  " _
                                        & SetSetring(sls_name.Text) & ",  " _
                                        & SetSetring(sls_desc.Text) & ",  " _
                                        & SetInteger(sls_event_id.Tag) & ",  " _
                                        & SetInteger(sls_pi_id.Tag) & ",  " _
                                        & SetDate(sls_start_date.DateTime) & ", " _
                                        & SetDate(sls_end_date.DateTime) & ", " _
                                        & SetDec(sls_cost.Text) & ",  " _
                                        & SetDec(sls_roi.Text) & ",  " _
                                        & SetDec(sls_target_qty.EditValue) & ",  " _
                                        & SetDec(sls_target_value.EditValue) & ",  " _
                                        & SetInteger(sls_tran_id.EditValue) & ",  " _
                                        & SetInteger(sls_status.EditValue) & ",  " _
                                        & (sls_active.Checked) & ", " _
    ...
    Public Overrides Function edit_data() As Boolean
        ...
        '        sls_code.Text = SetString(.Item("plans_emp_nik"))
        ...
        '        sls_cost.Text = SetString(.Item("plans_amount_tgt"))
        '        sls_target_qty.Text = SetString(.Item("plans_insentif"))
    ...
    Private Sub plans_sales_id_ButtonClick(ByVal sender As Object, ByVal e As DevExpress.XtraEditors.Controls.ButtonPressedEventArgs)
        'Try
    ...
    Private Sub BtGen_Click(ByVal sender As System.Object, ByVal e As System.EventArgs)
        ...
        'Private Sub plans_ce_special_CheckedChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles plans_ce_special.CheckedChanged
        '    Try
