...
Public Class FSalesQuotationConsigmentReOri
    ...
    Private Sub grid_detail()
        ...
        add_column_copy(gv_detail, "oid", "sqd_invc_oid", DevExpress.Utils.HorzAlignment.Default)
        ...
        add_column_copy(gv_detail, "Transfer Status", "ptsfr_trans_id", DevExpress.Utils.HorzAlignment.Default)
        ...
        add_column_copy(gv_detail, "SO Return", "so_return", DevExpress.Utils.HorzAlignment.Far, DevExpress.Utils.FormatType.Numeric, "n")
