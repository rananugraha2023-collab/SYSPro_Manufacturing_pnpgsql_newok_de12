...
Public Class FRosettaRuleHeader
    Dim ssql As String
    ...
    Public Overrides Sub format_grid()
        ...
        add_column_copy(gv_detail, "Account Code Hirarki", "ac_code_hirarki1", DevExpress.Utils.HorzAlignment.Center)
        ...
        add_column_copy(gv_detail, "For Account Code Hirarki", "ac_code_hirarki2", DevExpress.Utils.HorzAlignment.Center)
    ...
    Public Overrides Function edit_data() As Boolean
        If MyBase.edit_data = True Then
            ...
            With ds.Tables(0).Rows(row)
                _rstrule_oid_edit = .Item("rstrule_oid").ToString
                ...
                Using objinsert As New master_new.WDABasepgsql("", "")
                    With objinsert
                        ...
                        Try
                            ...
                            ssql = "delete from rstrule_mstr where rstrule_oid = '" + ds.Tables(0).Rows(row).Item("rstrule_oid").ToString + "'"
                            .Command.CommandType = CommandType.Text
                            .Command.CommandText = ssql
                            .Command.ExecuteNonQuery()
                            .Command.Parameters.Clear()
                ...
                Using objcb As New master_new.WDABasepgsql("", "")
                    With objcb
                        ...
                        While .DataReader.Read
                            If _rstrule_oid_edit.ToString <> .DataReader("rstrule_oid").ToString Then
