...
Public Class FDRCRMemo20240802
    ...
    Public _ar_ppn_type_id As String = ""

    Private Sub FDRCRMemo20240802_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        form_first_load()
