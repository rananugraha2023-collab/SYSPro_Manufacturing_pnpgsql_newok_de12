...
Public Class FDRCRMemo
    ...
    Public _arso_so_reff_oid As String
    ...
    Private Sub ap_ptnr_id_EditValueChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles ar_bill_to.EditValueChanged
        ...
        Try
            ...
            If _conf_limit_partner_group_ws = "1" Then
                If Not SetInteger(ar_bill_to.EditValue) = "Null" Then
                    sSql = "select ptnrg_credit_limit,ptnrg_term_of_payment from ptnrg_grp where ptnrg_id in (select ptnr_ptnrg_id from ptnr_mstr where ptnr_id=" & SetInteger(ar_bill_to.EditValue) & ")"
                    ...
                    sSql = "select code_id, code_name, code_usr_1 from code_mstr where code_field ~~* 'creditterms_mstr' and code_active ~~* 'Y'" _
                                     & " AND code_en_id in (0," & SetInteger(ar_en_id.EditValue) & ")" _
                    ...
                    For Each dr_term As DataRow In dt_term_payment.Rows
                        If Not dr_term("code_id") Is DBNull.Value Then
                            ar_credit_term.EditValue = dr_term("code_id")
                        End If
    ...
    Public Overrides Sub format_grid()
        ...
        add_column_copy(gv_detail_shipment, "Qty Shipment", "ars_shipment", DevExpress.Utils.HorzAlignment.Far, DevExpress.Utils.FormatType.Numeric, "n")
        ...
        add_column_copy(gv_detail_shipment, "Total Price", "tot_inv_price", DevExpress.Utils.HorzAlignment.Far, DevExpress.Utils.FormatType.Numeric, "n", DevExpress.Data.SummaryItemType.Sum, "SUM={0:n}")
        ...
        add_column(gv_edit_shipment, "Qty Shipment", "ars_shipment", DevExpress.Utils.HorzAlignment.Far, DevExpress.Utils.FormatType.Numeric, "n")
        add_column(gv_edit_shipment, "Qty Invoice", "ars_invoice", DevExpress.Utils.HorzAlignment.Far, DevExpress.Utils.FormatType.Numeric, "n")
        ...
        add_column(gv_edit_shipment, "Invoice Price", "ars_invoice_price", DevExpress.Utils.HorzAlignment.Far, DevExpress.Utils.FormatType.Numeric, "n")
        add_column(gv_edit_shipment, "Total Price", "tot_inv_price", DevExpress.Utils.HorzAlignment.Far, DevExpress.Utils.FormatType.Numeric, "n", DevExpress.Data.SummaryItemType.Sum, "SUM={0:n}")
    ...
    Public Overrides Sub insert_data_awal()
        ...
        arso_so_reff_id.Text = ""
        _arso_so_reff_oid = ""
        arso_so_reff_id.Enabled = True
                                ...
                                If ds.Tables("detail_shipment").Rows(i).Item("ars_ar_oid").ToString = ds.Tables(0).Rows(BindingContext(ds.Tables(0)).Position).Item("ar_oid").ToString Then
                                    ...
                                    If ds.Tables("detail_shipment").Rows(i).Item("ars_invoice") <> 0 Then
                                        ...
                                        .Command.CommandText = "update sod_det set sod_qty_invoice = sod_qty_invoice - " + SetDec(ds.Tables("detail_shipment").Rows(i).Item("ars_invoice").ToString) + _
                                                               " where sod_oid = (select soshipd_sod_oid from soshipd_det where soshipd_oid = '" + ds.Tables("detail_shipment").Rows(i).Item("ars_soshipd_oid").ToString + "')"
                                        ssqls.Add(.Command.CommandText)
                                        .Command.ExecuteNonQuery()
                                        .Command.Parameters.Clear()
                                    End If
    ...
    Private Sub arso_so_reff_id_ButtonClick(ByVal sender As Object, ByVal e As DevExpress.XtraEditors.Controls.ButtonPressedEventArgs) Handles arso_so_reff_id.ButtonClick
                        ...
                        For i = 0 To ds_edit_shipment.Tables(0).Rows.Count - 1
                            If ds_edit_shipment.Tables(0).Rows(i).Item("ceklist") = True Then
                                If ds_edit_shipment.Tables(0).Rows(i).Item("ars_invoice") <> 0 Then
                                    ...
                                    .Command.CommandType = CommandType.Text
                                    .Command.CommandText = "update soshipd_det set soshipd_qty_inv = coalesce(soshipd_qty_inv,0) + " + SetDec(ds_edit_shipment.Tables(0).Rows(i).Item("ars_invoice")) + _
...
& "  ars_invoice_price +(sod_price * sod_disc) as ars_invoice_price2, " _
& "  case ars_taxable " _
& "    when 'Y' then (ars_invoice *(ars_invoice_price * taxr_rate / 100)) " _
& "    else 0 " _
& "  end as ars_invoice_price_ppn, " _
& "  cmaddr_code, " _
& "  cmaddr_name, " _
& "  cmaddr_line_1, " _
& "  cmaddr_line_2, " _
...
& "  ac_name, " _
& "  ar_terbilang, " _
& "  coalesce(tranaprvd_name_1, " _
& "    '') as tranaprvd_name_1, " _
& "  coalesce(tranaprvd_name_2, " _
& "    '') as tranaprvd_name_2, " _
& "  coalesce(tranaprvd_name_3, " _
& "    '') as tranaprvd_name_3, " _
& "  coalesce(tranaprvd_name_4, " _
& "    '') as tranaprvd_name_4, " _
& "  tranaprvd_pos_1, " _
& "  tranaprvd_pos_2, " _
& "  tranaprvd_pos_3, " _
& "  tranaprvd_pos_4 " _
...
& "  inner join ptnr_mstr on ptnr_id = ar_bill_to " _
& "  inner join ( " _
& "  select distinct on (ptnra_ptnr_oid) " _
& "    ptnra_ptnr_oid, " _
& "    ptnra_line_1, " _
& "    ptnra_line_2, " _
& "    ptnra_line_3, " _
& "    ptnra_zip " _
& "  from ptnra_addr " _
& "  order by ptnra_ptnr_oid, ptnra_add_date desc " _
& ") ptnra_addr on ptnra_addr.ptnra_ptnr_oid = ptnr_oid " _
& "  inner join cu_mstr on cu_id = ar_cu_id " _
& "  inner join code_mstr um_master on um_master.code_id = sod_um " _
& "  inner join code_mstr credit_term_mstr on credit_term_mstr.code_id = ar_credit_term " _
& "  inner join cmaddr_mstr on cmaddr_en_id = ar_en_id " _
