...
Public Class XRFakturPajak
    ...
    Public _fp_en_id As Integer

    Private Sub XRFakturPajak_AfterPrint(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.AfterPrint
        'set_paper()
    End Sub

    Private Sub XRFakturPajak_BeforePrint(ByVal sender As Object, ByVal e As System.Drawing.Printing.PrintEventArgs) Handles Me.BeforePrint
        'cek_paper_available()
    End Sub
    ...
    Private Sub cek_paper_available()
        ...
        sql = "SELECT  " _
                            ...
                            & " and paper_en_id = " & SetNumber(_fp_en_id) _
