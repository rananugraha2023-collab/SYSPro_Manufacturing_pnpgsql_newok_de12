...
Public Class FDRCRMemoSDI26052023
    Public dt_bantu As DataTable
    Public func_data As New function_data
    Public func_coll As New function_collection
    Dim func_bill As New Cls_Bilangan
    Dim _ar_oid_mstr As String
    Public ds_edit, ds_edit_so, ds_edit_shipment, ds_edit_dist As DataSet
    Public _arso_so_reff_oid As String
    Public _ar_bill_to_id, _ar_credit_term_id, _ar_bk_ids, _ar_ac_ids, _ar_tax_class_ids As Integer
    Public _so_ref_po_oid, _so_sq_ref_oid, _sq_ref_oid, _sod_invc_oid, _ar_ppn_type_id As String
    Dim _now As DateTime
    Public _par_cus_id As String
    Dim _conf_limit_partner_group_ws As String

    Private Sub FDRCRMemoSDI26052023_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        form_first_load()
    ...
    Private Sub arso_so_reff_id_ButtonClick(ByVal sender As Object, ByVal e As DevExpress.XtraEditors.Controls.ButtonPressedEventArgs)
    ...
    Private Sub browse_so()
        ...
        'Browse PO berdasar kepada entity, patner, currency......ar_so_ref_code
                ...
                With objinsert
                    ...
                    Try
                        ...
                        For i = 0 To ds_edit_shipment.Tables(0).Rows.Count - 1
                            If ds_edit_shipment.Tables(0).Rows(i).Item("ceklist") = True Then
                                If ds_edit_shipment.Tables(0).Rows(i).Item("ars_invoice") <> 0 Then
                                    ...
                                    .Command.CommandType = CommandType.Text
                                    .Command.CommandText = "update soshipd_det set soshipd_qty_inv = coalesce(soshipd_qty_inv,0) + " + ds_edit_shipment.Tables(0).Rows(i).Item("ars_invoice").ToString + _
                        ...
                        If ar_pay_prepaid.EditValue <> 0 Then
                            ...
                            .Command.CommandType = CommandType.Text
                            .Command.CommandText = "update ptnr_mstr set ptnr_prepaid_balance = coalesce(ptnr_prepaid_balance,0) + " + _prepaid.ToString + _
                                                   " where ptnr_id = " + ar_bill_to.EditValue.ToString
