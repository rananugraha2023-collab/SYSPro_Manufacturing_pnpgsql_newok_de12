...
Partial Public Class XtraReport2
    ...
    Private Sub InitializeComponent()
        ...
        'TopMargin
        '
        Me.TopMargin.Controls.AddRange(New DevExpress.XtraReports.UI.XRControl() {Me.XrPivotGrid1})
        ...
        'XrPivotGrid1
        '
        Me.XrPivotGrid1.LocationFloat = New DevExpress.Utils.PointFloat(0.0!, 26.04167!)
