...
Public Class XRRecomendationApproval
    ...
    Private Sub XRRequisition_BeforePrint(ByVal sender As Object, ByVal e As System.Drawing.Printing.PrintEventArgs) Handles Me.BeforePrint
        Try
        ...
        'Try
        '    'rec_detail.Html = GetCurrentColumnValue("rec_detail")

        '    Dim WebBrowser1 As New WebBrowser

        '    WebBrowser1.ScrollBarsEnabled = False
        '    WebBrowser1.Size = New System.Drawing.Size(616, 424)

        '    WebBrowser1.DocumentText = GetCurrentColumnValue("rec_detail")
        ...
        'If GetCurrentColumnValue("req_trans_id") = "D" Then
        '    textWatermark.Text = "DRAFT"
        'ElseIf GetCurrentColumnValue("req_trans_id") = "W" Then
        '    textWatermark.Text = "NOT YET APPROVED"
        'ElseIf GetCurrentColumnValue("req_trans_id") = "X" Then
        '    textWatermark.Text = "CANCELED"
        'ElseIf GetCurrentColumnValue("req_trans_id") = "C" Then
        '    textWatermark.Text = "CLOSED"
        'ElseIf GetCurrentColumnValue("req_trans_id") = "I" Then
        '    textWatermark.Text = ""
        'End If
        'Me.Watermark.Font = New Font(Watermark.Font.FontFamily, 40)

        'Dim _font As New FontFamily

        'Me.Watermark.ForeColor = Color.LightSlateGray
        'Me.Watermark.ShowBehind = True
        'Me.Watermark.TextTransparency = 50
        ...
        '    'sSQL = "select distinct wf_oid, wf_ref_oid, wf_ref_code, " + _
        ...
        '    '    & " where wf_ref_code= '" & GetCurrentColumnValue("req_code") & "'   order by wf_ref_code, wf_seq "
    ...
    Private Sub cek_paper_available()
        ...
        '                    & " and paper_en_id = " & GetCurrentColumnValue("req_en_id").ToString _
    ...
    Private Sub set_paper()
        ...
        '                                    & SetInteger(GetCurrentColumnValue("req_en_id").ToString) & "," _
