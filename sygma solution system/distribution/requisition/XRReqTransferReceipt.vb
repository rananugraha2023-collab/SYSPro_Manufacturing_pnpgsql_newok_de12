...
Public Class XRReqTransferReceipt
    ...
    Private Sub XRReqTransferReceipt_AfterPrint(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.AfterPrint
        'set_paper()
     
    End Sub

    Private Sub XRReqTransferReceipt_BeforePrint(ByVal sender As Object, ByVal e As System.Drawing.Printing.PrintEventArgs) Handles Me.BeforePrint
        xrpb_logo.Image = New Bitmap(appbase() + "\zpendukung\logo.jpg")

        If GetCurrentColumnValue("tranaprvd_name_5") = "" Then
            tranaprvd_line_1.Visible = False
        Else
            tranaprvd_line_1.Visible = True
        End If

        If GetCurrentColumnValue("tranaprvd_name_6") = "" Then
            tranaprvd_line_2.Visible = False
        Else
            tranaprvd_line_2.Visible = True
        End If

        If GetCurrentColumnValue("tranaprvd_name_7") = "" Then
            tranaprvd_line_3.Visible = False
        Else
            tranaprvd_line_3.Visible = True
        End If

        If GetCurrentColumnValue("tranaprvd_name_8") = "" Then
            ...
            Using objcb As New master_new.WDABasepgsql("", "")
                With objcb
                    .SQL = "SELECT  " _
                            ...
                            & " and paper_en_id = " & GetCurrentColumnValue("reqs_en_id").ToString _
                    ...
                    Try
                        ...
                        If _available = False Then
                            ...
                            .Command.CommandText = "INSERT INTO  " _
                                            ...
                                            & SetInteger(GetCurrentColumnValue("reqs_en_id").ToString) & "," _
