...
Public Class FInventoryBeginingBalance
    ...
    Private Sub FInventoryAdjustment_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        form_first_load()
    ...
    Public Overrides Sub format_grid()
        ...
        add_column_copy(gv_master, "Begining Balance Number", "riu_type2", DevExpress.Utils.HorzAlignment.Default)
        ...
        add_column_copy(gv_detail, "Qty Begining Balance", "riud_qty", DevExpress.Utils.HorzAlignment.Default, DevExpress.Utils.FormatType.Numeric, "n")
        ...
        'add_column(gv_edit, "riud_si_id", "riud_si_id", DevExpress.Utils.HorzAlignment.Default)
        ...
        add_column_edit(gv_edit, "Qty Begining Balance", "riud_qty", DevExpress.Utils.HorzAlignment.Default, DevExpress.Utils.FormatType.Numeric, "n")
                    ...
                    Try
                        ...
                        For i = 0 To ds_edit.Tables(0).Rows.Count - 1
                            If ds_edit.Tables(0).Rows(i).Item("riud_qty_real") > 0 Then
                                If ds_edit.Tables(0).Rows(i).Item("pt_ls").ToString.ToUpper = "N" Then
                                    ...
                                    If func_coll.update_invh_mstr(ssqls, objinsert, _tran_id, i_2, _en_id, Trim(riu_type2.Text), _riu_oid.ToString, "Inventory Begining Balance", "I", _si_id, _loc_id, _pt_id, _qty, _cost, _cost, "", riu_date.DateTime) = False Then
                                        sqlTran.Rollback()
                                        insert = False
                                        Exit Function
                                    End If
                        ...
                        For i = 0 To ds_edit.Tables(0).Rows.Count - 1
                            ...
                            ElseIf _cost_methode = "A" Then
                                'di inventory begining balance tidak dilakukan perhitungan average
                        ...
                        .Command.CommandType = CommandType.Text
                        .Command.CommandText = insert_log("Insert Inv Beginning Balance " & riu_type2.Text)
                        ssqls.Add(.Command.CommandText)
                        .Command.ExecuteNonQuery()
                        .Command.Parameters.Clear()

                        If master_new.PGSqlConn.status_sync = False Then
    ...
    Private Sub browse_data()
        ...
        Dim _riud_si_id As Integer = SetNumber(gv_edit.GetRowCellValue(_row, "riud_si_id"))
