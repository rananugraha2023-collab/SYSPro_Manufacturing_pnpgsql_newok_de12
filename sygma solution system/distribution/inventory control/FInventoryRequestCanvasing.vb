...
Public Class FInventoryRequestCanvasing
    ...
    Private Sub FInventoryRequestCanvasing_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
                    ...
                    Try
                        ...
                        For i = 0 To ds_edit.Tables(0).Rows.Count - 1
                            ...
                            .Command.CommandText = "UPDATE pb2d_det set pbd_qty_processed= coalesce(pbd_qty_processed,0) + " & SetDbl(ds_edit.Tables(0).Rows(i).Item("pbd_qty")) _
                                            & " where pbd_oid =" & SetSetring(ds_edit.Tables(0).Rows(i).Item("pbd_pb2det_oid").ToString)
                ...
                With objinsert
                    ...
                    Try
                        ...
                        .Command.CommandText = "UPDATE  " _
                                            ...
                                            & "  pb_en_id = " & SetInteger(pb_en_id.EditValue) & ",  " _
                                            & "  pb_en_id_shipment = " & SetInteger(pb_en_id_shipment.EditValue) & ",  " _
