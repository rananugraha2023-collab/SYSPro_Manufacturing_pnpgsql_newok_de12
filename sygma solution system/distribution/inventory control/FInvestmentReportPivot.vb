...
Public Class FInvestmentReportPivot
    ...
    Private Sub format_pivot()
        ...
        add_column_pivot(pgc_ar, "Project", "investp_desc", DevExpress.XtraPivotGrid.PivotArea.RowArea)
        add_column_pivot(pgc_ar, "Investor", "ptnr_name", DevExpress.XtraPivotGrid.PivotArea.RowArea)
        add_column_pivot(pgc_ar, "Amount", "invest_pokok", DevExpress.XtraPivotGrid.PivotArea.DataArea, DevExpress.Utils.FormatType.Numeric, "n")
        add_column_pivot(pgc_ar, "Margin (%)", "invest_margin", DevExpress.XtraPivotGrid.PivotArea.DataArea, DevExpress.Utils.FormatType.Numeric, "n")
        add_column_pivot(pgc_ar, "TOP", "invest_top_bulan", DevExpress.XtraPivotGrid.PivotArea.DataArea, DevExpress.Utils.FormatType.Numeric, "n")
        add_column_pivot(pgc_ar, "Margin Total", "invest_total_margin", DevExpress.XtraPivotGrid.PivotArea.DataArea, DevExpress.Utils.FormatType.Numeric, "n")
        add_column_pivot(pgc_ar, "Investment Total", "invest_pengembalian_investasi", DevExpress.XtraPivotGrid.PivotArea.DataArea, DevExpress.Utils.FormatType.Numeric, "n")
        add_column_pivot(pgc_ar, "Payment Out", "invest_payment_out", DevExpress.XtraPivotGrid.PivotArea.DataArea, DevExpress.Utils.FormatType.Numeric, "n")
        add_column_pivot(pgc_ar, "Outstanding", "invest_outstanding", DevExpress.XtraPivotGrid.PivotArea.DataArea, DevExpress.Utils.FormatType.Numeric, "n")
        'add_column_pivot(pgc_ar, "Shipment Year", "pb_date", DevExpress.XtraPivotGrid.PivotArea.FilterArea, DevExpress.XtraPivotGrid.PivotGroupInterval.DateYear, "soship_date_year")
        'add_column_pivot(pgc_ar, "Shipment Month", "pb_date", DevExpress.XtraPivotGrid.PivotArea.FilterArea, DevExpress.XtraPivotGrid.PivotGroupInterval.DateMonth, "soship_date_month")
    ...
    Private Function set_sql() As String
        ...
        set_sql = "SELECT  " _
                ...
                & "  c.ptnr_code, " _
                & "  c.ptnr_name, " _
                & "  d.investp_desc,invest_payment_in,invest_payment_out,invest_pengembalian_investasi - coalesce(invest_payment_out,0) as  invest_outstanding " _
                & "FROM " _
