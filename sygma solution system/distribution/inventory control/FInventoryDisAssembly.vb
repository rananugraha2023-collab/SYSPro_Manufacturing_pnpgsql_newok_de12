...
Public Class FInventoryDisAssembly
    ...
    Public Overrides Sub format_grid()
        ...
        add_column_edit(gv_edit, "Qty", "psd_qty", DevExpress.Utils.HorzAlignment.Far, DevExpress.Utils.FormatType.Numeric, "n")
            ...
            Using objcb As New master_new.WDABasepgsql("", "")
                With objcb
                    .SQL = "SELECT  " _
                        ...
                        & "  " + SetSetring(asmb_loc_desc.Text) + " as loc_desc , " _
                        & "  '' as pla_ac_id , " _
                        & "  '-' as ac_code , " _
                        & "  '-' as ac_name, " _
    ...
    Public Overrides Sub insert_data_awal()
        ...
        asmb_loc_desc.Properties.ReadOnly = True
        asmb_loc_desc.Text = ""
        asmb_desc.Text = ""
        asmb_remarks.Text = ""
        asmb_qty.Text = 0
    ...
    Public Overrides Function insert() As Boolean
        ...
        _asmb_code = func_coll.get_transaction_number("DA", asmb_en_id.GetColumnValue("en_code"), "asmb_mstr", "asmb_code")
            ...
            Using objinsert As New master_new.WDABasepgsql("", "")
                With objinsert
                    ...
                    Try
                        ...
                        If func_coll.update_invc_mstr_minus(ssqls, objinsert, _en_id, _si_id, _loc_id, _pt_id, be_asmb_ps.Text, _serial, _qty) = False Then
                            sqlTran.Rollback()
                            insert = False
                            Exit Function
                        End If
                        ...
                        If func_coll.update_invh_mstr(ssqls, objinsert, _tran_id, _asmb_cost, _en_id, Trim(_asmb_code), _asmb_oid.ToString, "Inventory DisAssembly", "", _si_id, _loc_id, _pt_id, _qty, _asmb_cost, _cost_avg, "", asmb_date.DateTime) = False Then
                            sqlTran.Rollback()
                            insert = False
                            Exit Function
                        End If
