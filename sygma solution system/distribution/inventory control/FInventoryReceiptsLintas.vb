...
Public Class FInventoryReceiptsLintas
    ...
    Private Sub FInventoryReceipts_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        form_first_load()
    ...
    Public Overrides Sub format_grid()
        ...
        add_column_copy(gv_master, "Inventory Request Number", "riu_ref_pb_code", DevExpress.Utils.HorzAlignment.Default)
            ...
            Using objinsert As New master_new.WDABasepgsql("", "")
                With objinsert
                    ...
                    Try
                        ...
                        .Command.CommandType = CommandType.Text
                        .Command.CommandText = "UPDATE pb_mstr set pb_status_inv_receipt='Y',pb_inv_receipt_code=" & SetSetring(_riu_type2) _
                                & " where pb_oid=" & SetSetring(_riu_ref_pb_oid.ToString)
                            ...
                            If ds_edit.Tables(0).Rows(i).Item("riud_qty") > 0 Then
                                ...
                                If ds_edit.Tables(0).Rows(i).Item("riud_sod_oid").ToString <> "" Then
                                    ...
                                    .Command.CommandText = "update sod_det set sod_qty_ir = coalesce(sod_qty_ir,0) + " + SetDbl(ds_edit.Tables(0).Rows(i).Item("riud_qty")) _
                                                         & " where sod_oid  = " + SetSetring(ds_edit.Tables(0).Rows(i).Item("riud_sod_oid").ToString)
                                    ssqls.Add(.Command.CommandText)
                                    .Command.ExecuteNonQuery()
                                    .Command.Parameters.Clear()
                                End If
...
#End Region
    ...
    Private Sub riu_ref_so_code_ButtonClick(ByVal sender As Object, ByVal e As DevExpress.XtraEditors.Controls.ButtonPressedEventArgs) Handles riu_ref_pb_code.ButtonClick
    ...
    Private Sub SimpleButton1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs)
        Try
            Dim _string As String = "Mohon diproses Inventory receipt : Ajb Online : SQ8621102077700048 SO8621102077700047 Andi entitas SDI BANTEN diproses dengan Inventory Issue : IU8321102000100003 dari entitas SDI JAWA TIMUR"
            Dim _hasil As String = ""
            Dim _hasil2 As String = ""


            _hasil = _string.Substring(_string.IndexOf("SO"))
            _hasil2 = _hasil.Substring(0, _hasil.IndexOf(" "))
            MsgBox(_hasil2)
