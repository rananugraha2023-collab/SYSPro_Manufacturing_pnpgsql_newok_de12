Public Class FQRCodePurchaseReceiptPrint
    Public dt_bantu As DataTable
    Public func_data As New function_data

    Private Sub FFQRCodePurchaseReceiptPrint_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
