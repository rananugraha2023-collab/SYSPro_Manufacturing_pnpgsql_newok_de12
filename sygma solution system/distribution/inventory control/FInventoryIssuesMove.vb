...
Public Class FInventoryIssuesMove
    ...
    Private Sub FInventoryIssuesMove_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        form_first_load()
    ...
    Public Overrides Function get_sequel() As String
        get_sequel = "SELECT  " _
                    ...
                    & " and riu_type ~~* 'I' and coalesce(riu_is_sample,'N')='Y' " _
    ...
    Private Sub browse_data()
        ...
        ElseIf _col = "ac_code" Then
            ...
            _filter = " and ac_id in (SELECT  " _
              ...
              & "FROM  " _
              & "  public.enacc_mstr  " _
              & "Where enacc_en_id=" & SetInteger(riu_en_id.EditValue) & " and enacc_code='promo_account') "
                ...
                With objinsert
                    ...
                    Try
                        ...
                        .Command.CommandText = "INSERT INTO  " _
                                            ...
                                            & SetSetring(_riu_ref_pb_oid.ToString) & ",'Y',  " _
                                            & "" & SetDateNTime(master_new.PGSqlConn.CekTanggal) & "" & "  " _
                                            & ")"
