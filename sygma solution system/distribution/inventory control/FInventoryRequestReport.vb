...
Public Class FInventoryRequestReport
    ...
    Public Overrides Sub format_grid()
        ...
        add_column(gv_master, "pbd_pb2det_oid", False)
        add_column_copy(gv_master, "Product Req Number", "pbd_pb2_code", DevExpress.Utils.HorzAlignment.Default)
        add_column_copy(gv_master, "Entity", "en_desc", DevExpress.Utils.HorzAlignment.Default)
        ...
        add_column_copy(gv_master, "Qty Trans Process", "pbd_qty_processed", DevExpress.Utils.HorzAlignment.Far, DevExpress.Utils.FormatType.Numeric, "n")
        add_column_copy(gv_master, "Qty Trans Complete", "pbd_qty_completed", DevExpress.Utils.HorzAlignment.Far, DevExpress.Utils.FormatType.Numeric, "n")
...
#Region "SQL"
    Public Overrides Function get_sequel() As String
        get_sequel = "SELECT  " _
                    ...
                    & "  public.pbd_det.pbd_dt,pb_pbt_code,pbt_desc,pbd_pb2_code " _
                    & "  FROM " _
                    & "  public.pbd_det " _
