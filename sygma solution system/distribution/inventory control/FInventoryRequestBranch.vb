...
Public Class FInventoryRequestBranch
    ...
    Private Sub FInventorypbuest_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        _conf_value = "0" 'func_coll.get_conf_file("wf_inventory_request")
        form_first_load()
    ...
    Public Overrides Sub format_grid()
        ...
        add_column_copy(gv_detail, "Qty Process", "pbd_qty_processed", DevExpress.Utils.HorzAlignment.Far, DevExpress.Utils.FormatType.Numeric, "n")
...
#Region "SQL"
    Public Overrides Function get_sequel() As String
        get_sequel = "SELECT  false as pilih," _
                    ...
                    & "  public.pb2_mstr.pb_oid, " _
                    & "  public.pb2_mstr.pb_dom_id, " _
                    & "  public.pb2_mstr.pb_en_id, " _
                    ...
                    & "  public.pb2_mstr.pb_dt,pb_pbt_code,pbt_desc " _
                    & "FROM " _
                    & "  public.pb2_mstr " _
    ...
    Public Sub load_detail()
        ...
        sql = "SELECT  " _
            ...
            & "  public.pb2d_det.pbd_qty_processed, " _
            ...
            & "  public.pb2d_det.pbd_dt " _
            & "  FROM " _
            & "  public.pb2d_det " _
            & "  LEFT OUTER JOIN public.si_mstr ON (public.pb2d_det.pbd_si_id = public.si_mstr.si_id) " _
            & "  INNER JOIN public.en_mstr ON (public.pb2d_det.pbd_en_id = public.en_mstr.en_id) " _
            ...
            & "  where pb2d_det.pbd_pb_oid = '" & ds.Tables(0).Rows(BindingContext(ds.Tables(0)).Position).Item("pb_oid").ToString & "'"
        ...
        If _conf_value = "1" Then
            ...
            sql = "select distinct wf_oid, wf_ref_oid, wf_ref_code, " + _
                  ...
                  " inner join pb2_mstr on pb_code = wf_ref_code " + _
                  " inner join pb2d_det dt on dt.pbd_pb_oid = pb_oid " _
                & " where pb2_mstr.pb_oid = '" + ds.Tables(0).Rows(BindingContext(ds.Tables(0)).Position).Item("pb_oid").ToString & "'" _
            ...
            sql = "SELECT  " _
               & "  public.en_mstr.en_desc, " _
                ...
                & "  INNER JOIN public.pt_mstr ON (public.pb2d_det.pbd_pt_id = public.pt_mstr.pt_id) " _
                & "  INNER JOIN public.code_mstr ON (public.pb2d_det.pbd_um = public.code_mstr.code_id) " _
                & " where pb2_mstr.pb_oid = '" + ds.Tables(0).Rows(BindingContext(ds.Tables(0)).Position).Item("pb_oid").ToString & "'"
            ...
            sql = "select pb_oid, pb_code, pb_trans_id, false as status from pb2_mstr " _
                & " where pb_trans_id ~~* 'd' "
...
#Region "DML"
            ...
            Using objcb As New master_new.WDABasepgsql("", "")
                With objcb
                    .SQL = "SELECT  " _
                        ...
                        & "  INNER JOIN public.code_mstr ON (public.pb2d_det.pbd_um = public.code_mstr.code_id) " _
                        & "  INNER JOIN public.en_mstr ON (public.pb2d_det.pbd_en_id = public.en_mstr.en_id) " _
                        & " where public.pb2d_det.pbd_oid is null"
    ...
    Public Overrides Function insert() As Boolean
        ...
        _pb_code = func_coll.get_transaction_number("PQ", pb_en_id.GetColumnValue("en_code"), "pb2_mstr", "pb_code")
            ...
            Using objinsert As New master_new.WDABasepgsql("", "")
                With objinsert
                    ...
                    Try
                        ...
                        .Command.CommandType = CommandType.Text
                        .Command.CommandText = insert_log("Insert Product Request " & _pb_code)
                        ssqls.Add(.Command.CommandText)
                        .Command.ExecuteNonQuery()
                        .Command.Parameters.Clear()
                ...
                Using objcb As New master_new.WDABasepgsql("", "")
                    With objcb
                        .SQL = "SELECT  " _
                                ...
                                & "  INNER JOIN public.code_mstr ON (public.pb2d_det.pbd_um = public.code_mstr.code_id) " _
                                & "  INNER JOIN public.en_mstr ON (public.pb2d_det.pbd_en_id = public.en_mstr.en_id) " _
                                & "  INNER JOIN public.pb2_mstr ON (public.pb2d_det.pbd_pb_oid = public.pb2_mstr.pb_oid)" _
                                & " where public.pb2d_det.pbd_pb_oid = '" + ds.Tables(0).Rows(row).Item("pb_oid").ToString + "'"
            ...
            Using objinsert As New master_new.WDABasepgsql("", "")
                With objinsert
                    ...
                    Try
                        ...
                        .Command.CommandType = CommandType.Text
                        .Command.CommandText = "delete from pb2d_det where coalesce(pbd_qty_processed,0) = 0 and pbd_pb_oid = '" + _pb_oid_mstr + "'"
                        ssqls.Add(.Command.CommandText)
                        .Command.ExecuteNonQuery()
                        .Command.Parameters.Clear()
                        '******************************************************
    ...
    Public Overrides Function before_delete() As Boolean
        ...
        Try
            Using objcb As New master_new.WDABasepgsql("", "")
                With objcb
                    .SQL = "select coalesce(pbd_qty_processed,0) as pbd_qty_processed from pb2d_det " + _
                           " where pbd_pb_oid = '" + ds.Tables(0).Rows(BindingContext(ds.Tables(0)).Position).Item("pb_oid").ToString + "'"
                    .InitializeCommand()
                    .FillDataSet(ds_bantu, "pb2d_det")
                End With
            End Using
        Catch ex As Exception
            MessageBox.Show(ex.Message)
                ...
                Using objinsert As New master_new.WDABasepgsql("", "")
                    With objinsert
                        ...
                        Try
                            ...
                            .Command.CommandType = CommandType.Text
                            .Command.CommandText = "delete from pb2_mstr where pb_oid = '" + ds.Tables(0).Rows(BindingContext(ds.Tables(0)).Position).Item("pb_oid").ToString + "'"
                            ssqls.Add(.Command.CommandText)
                            .Command.ExecuteNonQuery()
                            .Command.Parameters.Clear()
                            ...
                            .Command.CommandType = CommandType.Text
                            .Command.CommandText = insert_log("Delete Product Request " & ds.Tables(0).Rows(BindingContext(ds.Tables(0)).Position).Item("pb_code"))
                            ssqls.Add(.Command.CommandText)
                            .Command.ExecuteNonQuery()
                            .Command.Parameters.Clear()
...
#End Region
                        ...
                        If preview_export(filename) = True Then
                            ...
                            If user_wf_email <> "" Then
                                If mf.sent_email(user_wf_email, master_new.ClsVar.email_cc, mf.title_email(par_title, par_code), format_email_bantu + vbCrLf + vbCrLf + master_new.ClsVar.sBody + vbCrLf + mf.petunjuk(), master_new.ClsVar.email_user_name, filename) = True Then
                                    If sent_sms(user_phone, "Mohon di approve IR : " & par_code & " entity : " & master_new.PGSqlConn.GetRowInfo("select en_desc from en_mstr where en_id = (select pb_en_id from pb2_mstr where pb_oid='" & par_oid & "') ")(0).ToString & " melalui email atau syspro, replay email jika setuju. SMS Center") = False Then
    ...
    Public Function preview_export(ByVal par_filename As String) As Boolean
        Try
            ...
            _sql = "SELECT " _
                & "pb2_mstr.pb_oid, " _
                & "pb2_mstr.pb_dom_id,  " _
                & "pb2_mstr.pb_en_id,  " _
                & "pb2_mstr.pb_add_by,  " _
                & "pb2_mstr.pb_add_date, " _
                & "pb2_mstr.pb_upd_by,  " _
                & "pb2_mstr.pb_upd_date,  " _
                & "pb2_mstr.pb_date,  " _
                & "pb2_mstr.pb_due_date, " _
                & "pb2_mstr.pb_requested,  " _
                & "pb2_mstr.pb_end_user,  " _
                & "pb2_mstr.pb_rmks, " _
                & "pb2_mstr.pb_status,  " _
                & "pb2_mstr.pb_close_date,  " _
                & "pb2_mstr.pb_dt,  " _
                & "pb2_mstr.pb_code, " _
                & "pb2d_det.pbd_oid,  " _
                & "pb2d_det.pbd_dom_id,  " _
                & "pb2d_det.pbd_en_id,  " _
                & "pb2d_det.pbd_add_by,  " _
                & "pb2d_det.pbd_add_date,  " _
                & "pb2d_det.pbd_upd_by,  " _
                & "pb2d_det.pbd_upd_date,  " _
                & "pb2d_det.pbd_pb_oid,  " _
                & "pb2d_det.pbd_seq,  " _
                & "pb2d_det.pbd_pt_id,  " _
                & "pb2d_det.pbd_rmks, " _
                & "pb2d_det.pbd_end_user,  " _
                & "pb2d_det.pbd_qty,  " _
                & "pb2d_det.pbd_qty_processed, " _
                & "pb2d_det.pbd_qty_completed,  " _
                & "pb2d_det.pbd_um,  " _
                & "pb2d_det.pbd_due_date,  " _
                & "pb2d_det.pbd_status,  " _
                & "pb2d_det.pbd_dt,  " _
                & "pt_mstr.pt_code,  " _
                & "pt_mstr.pt_desc1,  " _
                & "pt_mstr.pt_desc2,  " _
                ...
                & "FROM pb2_mstr " _
                & "inner join pb2d_det on pb2_mstr.pb_oid = pb2d_det.pbd_pb_oid " _
                & "inner join en_mstr on pb2_mstr.pb_en_id = en_mstr.en_id " _
                & "inner join pt_mstr on pb2d_det.pbd_pt_id = pt_mstr.pt_id " _
                & "inner join code_mstr on pb2d_det.pbd_um = code_mstr.code_id  " _
                & "inner join cmaddr_mstr on pb2_mstr.pb_en_id = cmaddr_mstr.cmaddr_en_id " _
                & "left outer join tranaprvd_dok on tranaprvd_tran_oid = pb_oid " _
                & "WHERE " _
                & "pb2_mstr.pb_code ~~* '" + ds.Tables(0).Rows(BindingContext(ds.Tables(0)).Position).Item("pb_code") + "' " _
                & "order by pb2_mstr.pb_code"
        ...
        If preview_export(filename) = True Then
            ...
            If user_wf_email <> "" Then
                ...
                If mf.sent_email(user_wf_email, master_new.ClsVar.email_cc, mf.title_email(_title, _code), format_email_bantu + vbCrLf + vbCrLf + master_new.ClsVar.sBody + vbCrLf + mf.petunjuk(), master_new.ClsVar.email_user_name, filename) = True Then
                    If sent_sms(user_phone, "Mohon di approve IR : " & _code & " entity : " & master_new.PGSqlConn.GetRowInfo("select en_desc from en_mstr where en_id = (select pb_en_id from pb2_mstr where pb_oid='" & _oid & "') ")(0).ToString & " melalui email atau syspro, replay email jika setuju. SMS Center") = False Then
                        Box("Gagal mengirim pesan")
                        'Exit Sub
                    End If
                    Box("Email success")
                    ...
                    Using objinsert As New master_new.WDABasepgsql("", "")
                        With objinsert
                            ...
                            Try
                                ...
                                .Command.Transaction = sqlTran
                                .Command.CommandType = CommandType.Text
                                .Command.CommandText = "update pb2_mstr set pb_trans_id = '" + _trans_id + "'," + _
        ...
        Try
            ...
            For Each dr As DataRow In ds.Tables(0).Rows
                If dr("pilih") = True Then
                    sSQL = "update pb2_mstr set pb_status='X' where pb_oid='" & dr("pb_oid").ToString & "' and coalesce(pb_status,'')<>'C'"
