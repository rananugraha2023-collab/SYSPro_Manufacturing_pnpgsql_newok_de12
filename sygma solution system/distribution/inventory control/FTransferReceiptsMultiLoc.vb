...
Public Class FTransferReceiptsMultiLoc
    ...
    Private Sub FTransferReceipts_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        'TODO: This line of code loads data into the 'Ds_transfer_printout1.DataTable1' table. You can move, or remove it, as needed.
        'Me.DataTable1TableAdapter.Fill(Me.Ds_transfer_printout1.DataTable1)
        form_first_load()
    ...
    Public Overrides Sub format_grid()
        ...
        add_column_copy(gv_detail, "Qty Issues", "ptsfrd_qty", DevExpress.Utils.HorzAlignment.Default, DevExpress.Utils.FormatType.Numeric, "n")
        ...
        add_column(gv_edit, "Location From", "loc_desc", DevExpress.Utils.HorzAlignment.Default)
        add_column(gv_edit, "Qty Issue", "ptsfrd_qty", DevExpress.Utils.HorzAlignment.Default, DevExpress.Utils.FormatType.Numeric, "n")
        add_column(gv_edit, "Qty Receipt", "ptsfrd_qty_receive", DevExpress.Utils.HorzAlignment.Default, DevExpress.Utils.FormatType.Numeric, "n")
        'add_column(gv_edit, "Qty Return", "ptsfrd_qty_return", DevExpress.Utils.HorzAlignment.Default, DevExpress.Utils.FormatType.Numeric, "n")
        ...
        add_column(gv_serial, "Qty Return", "ptsfrds_qty_return", DevExpress.Utils.HorzAlignment.Default, DevExpress.Utils.FormatType.Numeric, "n")
    ...
    Public Overrides Function edit_data() As Boolean
        ...
        If MyBase.edit_data = True Then
            ...
            With ds.Tables(0).Rows(row)
                _ptsfr_oid_mstr = .Item("ptsfr_oid").ToString
                ...
                Using objcb As New master_new.WDABasepgsql("", "")
                    With objcb
                        ...
                        .SQL = "SELECT  " _
                            ...
                            & "  INNER JOIN public.code_mstr ON (public.ptsfrd_det_multi.ptsfrd_um = public.code_mstr.code_id) " _
                            & "  left outer join loc_mstr loc_mstr_from on loc_mstr_from.loc_id = ptsfrd_loc_from_id " _
                            & "  where ptsfrd_det_multi.ptsfrd_ptsfr_oid = '" + ds.Tables(0).Rows(row).Item("ptsfr_oid").ToString + "'"
                ...
                Using objcb As New master_new.WDABasepgsql("", "")
                    With objcb
                        .SQL = "SELECT  " _
                            ...
                            & "  inner join si_mstr on si_id = ptsfrds_si_id " _
                            & "  inner join loc_mstr on loc_id = ptsfrds_loc_id " _
                            & "  where ptsfrd_det.ptsfrd_ptsfr_oid = '" + ds.Tables(0).Rows(row).Item("ptsfr_oid").ToString + "'"
                        .InitializeCommand()
            ...
            Using objinsert As New master_new.WDABasepgsql("", "")
                With objinsert
                    ...
                    Try
                        ...
                        .Command.CommandText = "update ptsfr_mstr_multi set ptsfr_receive_date = " + SetDate(ptsfr_receive_date.DateTime) + ",ptsfr_trans_id='C' " _
                                             & " where ptsfr_oid = '" + ds.Tables(0).Rows(BindingContext(ds.Tables(0)).Position).Item("ptsfr_oid").ToString + "'"
                        ...
                        For i = 0 To ds_edit.Tables(0).Rows.Count - 1
                            .Command.CommandType = CommandType.Text
                            .Command.CommandText = "update ptsfrd_det_multi set ptsfrd_qty_receive = " + SetDbl(ds_edit.Tables(0).Rows(i).Item("ptsfrd_qty_receive").ToString) _
    ...
    End Function
    Private Function update_tranaprvd_det(ByVal par_en_id As Integer, ByVal par_type As Integer, ByVal par_table As String, ByVal par_initial As String, ByVal par_tran_code_awal As String, ByVal par_tran_code_akhir As String, ByVal par_date As Date) As Boolean
    ...
    Public Overrides Sub preview()
        ...
        update_tranaprvd_det(_en_id, _type, _table, _initial, _code_awal, _code_akhir, _now)
        ...
        frm._ssql = _sql
        frm._report = "XRTransferReceiptMultiPrint"
