Imports DevExpress.XtraPrinting.XtraPageSettings
Imports npgsql
Imports master_new.ModFunction

Public Class XRInvIssue
    ...
    Private Sub XRInvIssue_AfterPrint(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.AfterPrint
        ...
        '                                    & SetInteger(GetCurrentColumnValue("riu_en_id").ToString) & "," _
    ...
    Private Sub XRInvIssue_BeforePrint(ByVal sender As Object, ByVal e As System.Drawing.Printing.PrintEventArgs) Handles Me.BeforePrint
        ...
        '                    & " and paper_en_id = " & GetCurrentColumnValue("riu_en_id").ToString _
