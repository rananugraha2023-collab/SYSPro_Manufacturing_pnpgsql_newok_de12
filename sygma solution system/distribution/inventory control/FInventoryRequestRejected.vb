...
Public Class FInventoryRequestRejected
    ...
    Public Overrides Sub load_cb()
        ...
        pb_en_id_shipment.Properties.DataSource = dt_bantu
        pb_en_id_shipment.Properties.DisplayMember = dt_bantu.Columns("en_desc").ToString
        pb_en_id_shipment.Properties.ValueMember = dt_bantu.Columns("en_id").ToString
        pb_en_id_shipment.ItemIndex = 0
    ...
    Public Overrides Sub format_grid()
        ...
        add_column_copy(gv_master, "Status Reject Web", "pb_status_reject_web", DevExpress.Utils.HorzAlignment.Default)
        add_column_copy(gv_master, "Inventory Request Reject Reff", "pb_reff_code", DevExpress.Utils.HorzAlignment.Default)

        add_column_copy(gv_master, "Status Inventory Issue", "pb_status_inv_issue", DevExpress.Utils.HorzAlignment.Default)
        add_column_copy(gv_master, "Inventory Issue", "pb_inv_issue_code", DevExpress.Utils.HorzAlignment.Default)

        '
        add_column_copy(gv_master, "Status Inventory Receipt", "pb_status_inv_receipt", DevExpress.Utils.HorzAlignment.Default)
        add_column_copy(gv_master, "Inventory Receipt", "pb_inv_receipt_code", DevExpress.Utils.HorzAlignment.Default)
        ...
        add_column(gv_detail, "pbd_pb2_oid", False)
        add_column(gv_detail, "pbd_pb2det_oid", False)
        add_column_copy(gv_detail, "Product Req Number", "pbd_pb2_code", DevExpress.Utils.HorzAlignment.Default)
        ...
        add_column_copy(gv_detail, "Qty", "pbd_qty", DevExpress.Utils.HorzAlignment.Far, DevExpress.Utils.FormatType.Numeric, "n")
        add_column_copy(gv_detail, "Qty Trans Process", "pbd_qty_processed", DevExpress.Utils.HorzAlignment.Far, DevExpress.Utils.FormatType.Numeric, "n")
        'complete teh buat kalau sudah receipt
        add_column_copy(gv_detail, "Qty Trans Complete", "pbd_qty_completed", DevExpress.Utils.HorzAlignment.Far, DevExpress.Utils.FormatType.Numeric, "n")
        add_column_copy(gv_detail, "Qty Issue Process", "pbd_qty_riud", DevExpress.Utils.HorzAlignment.Far, DevExpress.Utils.FormatType.Numeric, "n")
        ...
        add_column(gv_edit, "pbd_pb2_oid", False)
        add_column(gv_edit, "pbd_pb2det_oid", False)
        add_column(gv_edit, "Product Req Number", "pbd_pb2_code", DevExpress.Utils.HorzAlignment.Default)
        ...
        add_column_edit(gv_edit, "Qty", "pbd_qty", DevExpress.Utils.HorzAlignment.Far, DevExpress.Utils.FormatType.Numeric, "n")
        ...
        add_column_copy(gv_email, "Qty", "pbd_qty", DevExpress.Utils.HorzAlignment.Far, DevExpress.Utils.FormatType.Numeric, "n")
...
#Region "SQL"
    Public Overrides Function get_sequel() As String
        get_sequel = "SELECT  false as pilih," _
                    & "  public.en_mstr.en_desc,public.en_mstr.en_code, " _
                    ...
                    & "  public.pb_mstr.pb_tran_id,pb_inv_issue_code,pb_inv_receipt_code, " _
                    & "  public.pb_mstr.pb_trans_id,pb_reff_code,pb_status_inv_issue,pb_status_inv_receipt,pb_status_reject_web, " _
                    & "  public.pb_mstr.pb_close_date, " _
                    & "  public.pb_mstr.pb_dt,pb_pbt_code,pbt_desc,pb_en_id_shipment,en_mstr_shipment.en_desc as en_desc_shipment,en_mstr_shipment.en_code as en_code_shipment " _
                    & "FROM " _
                    & "  public.pb_mstr " _
                    ...
                    & "  LEFT OUTER JOIN public.en_mstr en_mstr_shipment ON (pb_en_id_shipment = en_mstr_shipment.en_id) " _
                    & " where pb_wo_oid is  null and pb_date >= " + SetDate(pr_txttglawal.DateTime.Date) + "" _
                    & " and pb_date <= " + SetDate(pr_txttglakhir.DateTime.Date) + "  " _
                    & " and pb_en_id_shipment in (select user_en_id from tconfuserentity " _
    ...
    Public Sub load_detail()
        ...
        sql = "SELECT  " _
            ...
            & "  public.pbd_det.pbd_en_id, " _
            & "  public.en_mstr.en_desc, " _
            & "  public.pbd_det.pbd_si_id,pbd_pb2_code,pbd_pb2_oid,pbd_pb2det_oid, " _
            & "  public.si_mstr.si_desc, " _
            & "  public.pbd_det.pbd_add_by, " _
            & "  public.pbd_det.pbd_add_date, " _
            & "  public.pbd_det.pbd_upd_by, " _
...
#Region "DML"
            ...
            Using objcb As New master_new.WDABasepgsql("", "")
                With objcb
                    .SQL = "SELECT  " _
                        ...
                        & "  public.code_mstr.code_name, " _
                        & "  public.pbd_det.pbd_due_date, " _
                        & "  public.pbd_det.pbd_status,pbd_pb2_oid,pbd_pb2det_oid,pbd_pb2_code, " _
                        & "  public.pbd_det.pbd_dt " _
                        & "FROM " _
                        & "  public.pbd_det " _
                        & "  LEFT OUTER JOIN public.si_mstr ON (public.pbd_det.pbd_si_id = public.si_mstr.si_id) " _
    ...
    Public Overrides Function insert() As Boolean
        ...
        _pb_code = func_coll.get_transaction_number("IR", pb_en_id.GetColumnValue("en_code"), "pb_mstr", "pb_code")
                ...
                With objinsert
                    ...
                    Try
                        ...
                        .Command.CommandText = "INSERT INTO  " _
                                            ...
                                            & "  pb_rmks, " _
                                            & "  pb_tran_id, " _
                                            & "  pb_trans_id,pb_pbt_code,pb_en_id_shipment, " _
                                            & "  pb_dt " _
                                            & ")  " _
                                            & "VALUES ( " _
                                            ...
                                            & SetInteger(pb_en_id_shipment.EditValue) & ",  " _
                                            & "" & SetDateNTime(master_new.PGSqlConn.CekTanggal) & "" & "  " _
                                            & ")"
                        ...
                        For i = 0 To ds_edit.Tables(0).Rows.Count - 1
                            ...
                            .Command.CommandText = "INSERT INTO  " _
                                                ...
                                                & "  pbd_pt_id, " _
                                                & "  pbd_rmks, " _
                                                & "  pbd_end_user,pbd_pb2_oid,pbd_pb2det_oid,pbd_pb2_code, " _
                                                & "  pbd_qty, " _
                                                & "  pbd_um, " _
                                                & "  pbd_due_date, " _
                                                & "  pbd_dt " _
                                                ...
                                                & SetSetringDB(ds_edit.Tables(0).Rows(i).Item("pbd_pb2_oid")) & ",  " _
                                                & SetSetringDB(ds_edit.Tables(0).Rows(i).Item("pbd_pb2det_oid")) & ",  " _
                                                & SetSetringDB(ds_edit.Tables(0).Rows(i).Item("pbd_pb2_code")) & ",  " _
                            ...
                            .Command.CommandType = CommandType.Text
                            .Command.CommandText = "UPDATE pb2d_det set pbd_qty_processed= coalesce(pbd_qty_processed,0) + " & SetDbl(ds_edit.Tables(0).Rows(i).Item("pbd_qty")) _
                                            & " where pbd_oid =" & SetSetring(ds_edit.Tables(0).Rows(i).Item("pbd_pb2det_oid"))
    ...
    Public Overrides Function edit_data() As Boolean
        ...
        If MyBase.edit_data = True Then
            ...
            With ds.Tables(0).Rows(row)
                _pb_oid_mstr = .Item("pb_oid").ToString
                ...
                pb_en_id_shipment.EditValue = .Item("pb_en_id_shipment")
            End With
            pb_en_id.Focus()
                ...
                Using objcb As New master_new.WDABasepgsql("", "")
                    With objcb
                        .SQL = "SELECT  " _
                                ...
                                & "  public.pbd_det.pbd_end_user, " _
                                & "  public.pbd_det.pbd_qty, " _
                                & "  public.pbd_det.pbd_qty_processed,pbd_pb2_code,pbd_pb2_oid,pbd_pb2det_oid, " _
                                & "  public.pbd_det.pbd_qty_completed, " _
                                & "  public.pbd_det.pbd_um, " _
                                & "  public.code_mstr.code_name, " _
                                & "  public.pbd_det.pbd_due_date, " _
                ...
                With objinsert
                    ...
                    Try
                        ...
                        .Command.CommandText = "UPDATE  " _
                                            ...
                                            & "  pb_en_id_shipment = " & pb_en_id_shipment.EditValue & ",  " _
                        ...
                        For Each dr_det As DataRow In dt_detail.Rows
                            ...
                            .Command.CommandType = CommandType.Text
                            .Command.CommandText = "UPDATE pb2d_det set pbd_qty_processed= coalesce(pbd_qty_processed,0) - " & SetDbl(dr_det("pbd_qty")) _
                                            & " where pbd_oid =" & SetSetring(dr_det("pbd_pb2det_oid"))
                        ...
                        For i = 0 To ds_edit.Tables(0).Rows.Count - 1
                            ...
                            If _pbd_qty_processed = 0 Then
                                ...
                                .Command.CommandText = "INSERT INTO  " _
                                                    ...
                                                    & SetSetringDB(ds_edit.Tables(0).Rows(i).Item("pbd_pb2_oid")) & ",  " _
                                                    & SetSetringDB(ds_edit.Tables(0).Rows(i).Item("pbd_pb2det_oid")) & ",  " _
                                                    & SetSetringDB(ds_edit.Tables(0).Rows(i).Item("pbd_pb2_code").ToString) & ",  " _
                ...
                Using objinsert As New master_new.WDABasepgsql("", "")
                    With objinsert
                        ...
                        Try
                            ...
                            .Command.CommandType = CommandType.Text
                            .Command.CommandText = "delete from pb_mstr where pb_oid = '" + ds.Tables(0).Rows(BindingContext(ds.Tables(0)).Position).Item("pb_oid").ToString + "'"
                            ssqls.Add(.Command.CommandText)
                            .Command.ExecuteNonQuery()
                            .Command.Parameters.Clear()

                            .Command.CommandType = CommandType.Text
                            .Command.CommandText = "delete from wf_mstr where wf_ref_oid = '" + ds.Tables(0).Rows(BindingContext(ds.Tables(0)).Position).Item("pb_oid").ToString + "'"
                            ssqls.Add(.Command.CommandText)
                            .Command.ExecuteNonQuery()
                            .Command.Parameters.Clear()
...
#Region "gv_edit"
    ...
    Private Sub browse_data()
        ...
        ElseIf _col = "code_name" Then
            ...
            frm.type_form = True
            frm.ShowDialog()
        ElseIf _col = "pbd_pb2_code" Then
            Dim frm As New FProductRequestSearch
            frm.set_win(Me)
            frm._row = _row
...
#End Region
    ...
    Public Overrides Sub approve_line()
        ...
        _oid = ds.Tables(0).Rows(BindingContext(ds.Tables(0)).Position).Item("pb_oid").ToString
        _colom = "pb_trans_id"
        _table = "pb_mstr"
        _criteria = "pb_code"
        _initial = "pb"
    ...
    Public Overrides Sub cancel_line()
        Try
            ...
            Try
                ...
                Dim json_det As String = ""
                With ds.Tables(0).Rows(BindingContext(ds.Tables(0)).Position)

                    If SetString(.Item("pb_status")) = "C" Or SetString(.Item("pb_status")) = "X" Then
                        MessageBox.Show("Check Status..", "Error", MessageBoxButtons.OK, MessageBoxIcon.Error)
                        Exit Sub
                    End If


                    For Each dr_det As DataRow In ds.Tables("detail").Rows
                        json_det = json_det & "{""pbd_pt_code"":""" & dr_det("pt_code") & """,""pbd_qty"":" & dr_det("pbd_qty") & "},"
                    Next

                    If json_det <> "" Then
                        json_det = json_det.Substring(0, json_det.Length - 1)
                    End If

                    jsonstring = "{""pb_en_code"":""" & .Item("en_code") _
                        & """,""pb_reff_code"":""" & .Item("pb_code") & """,""pb_end_user"":""" & SetStringJson(.Item("pb_end_user")) & """," _
                       & """pb_rmks"":""" & SetStringJson(.Item("pb_rmks")) & """," _
                       & """pb_en_code_shipment"":""" & .Item("en_code_shipment") & """,""pb_date"":""" & CDate(.Item("pb_date")).ToString("yyyy-MM-dd") _
                       & """,""pb_requested"":""" & .Item("pb_requested") & """," _
                       & """detail"":[" & json_det & "]}"
                ...
                Dim url As String = func_coll.get_http_server_api() & "php56/json/curl_api_sdi.php?app=" _
                    & _app & "&path=inventory_request&json_string=" & jsonstring
                ...
                If SetString(result) <> "" Then
                    ...
                    If SetString(result2.GetValue("data").ToString()) <> "" Then
                        ...
                        For Each item As JObject In _data
                            _pb_code_reff = item.GetValue("pb_code").ToString()
                        Next
                    End If
                End If
                ...
                If _pb_code_reff <> "" Then
                    sSQL = "update pb_mstr set pb_status='X',pb_status_reject_web='Y',pb_reff_code=" & SetSetring(_pb_code_reff) _
                    & " where pb_oid='" & ds.Tables(0).Rows(BindingContext(ds.Tables(0)).Position).Item("pb_oid").ToString _
                    & "' "

                    sSQLs.Add(sSQL)

                    If SetString(ds.Tables(0).Rows(BindingContext(ds.Tables(0)).Position).Item("pb_oid")) <> "" Then
                        _ir_code = _ir_code & ds.Tables(0).Rows(BindingContext(ds.Tables(0)).Position).Item("pb_code") & " [" _
                        & SetString(ds.Tables(0).Rows(BindingContext(ds.Tables(0)).Position).Item("pb_rmks")) & "],"
                    End If
                    '    End If
                    'Next
                    ...
                    If _ir_code <> "" And func_coll.get_conf_file("transfer_issue_limit_entity_shipment") = "1" Then

                        Dim _telegram_id As String = ""
                        'Dim ssql As String
                        sSQL = "select * from tconfuser x where x.pin='LOG' and x.userid in " _
                            & "(select z.userid from tconfuserentity z  where  z.user_en_id = " & SetInteger(ds.Tables(0).Rows(BindingContext(ds.Tables(0)).Position).Item("pb_en_id")) & ")"

                        Dim dt_telegram As New DataTable
                        dt_telegram = GetTableData(sSQL)

                        For Each dr_tele As DataRow In dt_telegram.Rows
                            _telegram_id = dr_tele("user_id_telegram")
                        Next

                        Dim _alamat_api As String = "" & func_coll.get_http_server_api() & "php72/api_iot/kirim_id.php?id=" & _telegram_id _
                        & "&pesan=" & "Telah ditolak Transfer Issue untuk Inventory Request : " & _ir_code & " entitas " & ds.Tables(0).Rows(BindingContext(ds.Tables(0)).Position).Item("en_desc") & " karena stok kosong. Transaksi akan diproses menggunakan Inventory Issue dan Inventory Receipt."

                        Dim result_tele As String
                        result_tele = mf.run_get_to_api(_alamat_api & "")

                        If _telegram_id <> "" Then
                            If SetString(result_tele).Contains("success") Then
                        ...
                        With objinsert
                            ...
                            Try
                                ...
                                .Command.CommandText = "update pb_mstr set pb_trans_id = '" + _trans_id + "'," + _
                                               ...
                                               " pb_upd_date = " & SetDateNTime(master_new.PGSqlConn.CekTanggal) & " " + _
                                               " where pb_oid = '" + ds.Tables("smart").Rows(i).Item("pb_oid").ToString + "'"
    ...
    Public Overrides Function export_data() As Boolean
        ...
        Try
            ssql = "SELECT " _
                ...
                & "code_mstr.code_code, " _
                & "coalesce(tranaprvd_name_1,'') as tranaprvd_name_1, coalesce(tranaprvd_name_2,'') as tranaprvd_name_2, coalesce(tranaprvd_name_3,'') as tranaprvd_name_3, coalesce(tranaprvd_name_4,'') as tranaprvd_name_4, " _
                & "tranaprvd_pos_1, tranaprvd_pos_2, tranaprvd_pos_3, tranaprvd_pos_4,pb_en_id_shipment,en_mstr_shipment.en_desc as en_desc_shipment,en_mstr_shipment.en_code as en_code_shipment " _
                & "FROM pb_mstr " _
                & "inner join pbd_det on pb_mstr.pb_oid = pbd_det.pbd_pb_oid " _
                & "inner join en_mstr on pb_mstr.pb_en_id = en_mstr.en_id " _
                & "  LEFT OUTER JOIN public.en_mstr en_mstr_shipment ON (pb_en_id_shipment = en_mstr_shipment.en_id) " _
            ...
            With frm
                ...
                add_column_copy(.gv_export, "Entity Shipment", "en_desc_shipment", DevExpress.Utils.HorzAlignment.Default)
                ...
                add_column_copy(.gv_export, "Qty", "pbd_qty", DevExpress.Utils.HorzAlignment.Far, DevExpress.Utils.FormatType.Numeric, "n")
                add_column_copy(.gv_export, "Qty Trans Process", "pbd_qty_processed", DevExpress.Utils.HorzAlignment.Far, DevExpress.Utils.FormatType.Numeric, "n")
                add_column_copy(.gv_export, "Qty Trans Complete", "pbd_qty_completed", DevExpress.Utils.HorzAlignment.Far, DevExpress.Utils.FormatType.Numeric, "n")
                add_column_copy(.gv_export, "Qty Issue Process", "pbd_qty_riud", DevExpress.Utils.HorzAlignment.Far, DevExpress.Utils.FormatType.Numeric, "n")
    ...
    Private Sub CancelToolStripMenuItem_Click(ByVal sender As System.Object, ByVal e As System.EventArgs)
        Try
            ...
            For Each dr As DataRow In ds.Tables(0).Rows
                If dr("pilih") = True Then
                    sSQL = "update pb_mstr set pb_status='X' where pb_oid='" & dr("pb_oid").ToString & "' and coalesce(pb_status,'')<>'C'"
    ...
    Private Sub SimpleButton1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles SimpleButton1.Click
        Try
            ...
            Dim jsonstring As String
            jsonstring = "{""pb_en_code"": ""86"",""pb_end_user"": ""Andi"",""pb_rmks"": ""Ajb Online : SQ8621102077700048 SO8621102077700047 Andi"",	""pb_en_code_shipment"": ""83"",""pb_date"": ""2021-10-08T07:01:23"",""pb_requested"": ""IR8621102077700045"",""detail"": [{""pbd_pt_code"":""PT99800004123"",""pbd_qty"": 1}]}"
            jsonstring = jsonstring.Replace(" ", "%20")

            Dim url As String = func_coll.get_http_server_api() & "php56/json/curl_api_sdi.php?url=" & "https://10.10.10.148:5001/api/inventory_request" & "&json_string=" & jsonstring
            'Dim uri As New Uri(url)
            ...
            If SetString(result).Contains("""status"": true,") Then
    ...
    Private Function SendRequest(ByVal uri As Uri, ByVal jsonDataBytes As Byte(), ByVal contentType As String, ByVal method As String) As String
        ...
        request.Headers.Add("api_token", "f2a7f94d-79ce-4d4b-b113-55c3b22ef049")
        request.Headers.Add("api_user", "sdi")
        request.Headers.Add("api_password", "271fb739ef0d9a027d8596f9f2c521dd")
    ...
    Private Sub UpdateEntityShipmentToolStripMenuItem_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles UpdateEntityShipmentToolStripMenuItem.Click
        Try
            If SetString(ds.Tables(0).Rows(BindingContext(ds.Tables(0)).Position).Item("pb_status")) = "C" Then
                MessageBox.Show("Data already closed..", "Information", MessageBoxButtons.OK, MessageBoxIcon.Information)

                Exit Sub
            End If

            If SetString(ds.Tables(0).Rows(BindingContext(ds.Tables(0)).Position).Item("pb_status_inv_issue")) = "Y" Then
                MessageBox.Show("Data already Inv Issued..", "Information", MessageBoxButtons.OK, MessageBoxIcon.Information)

                Exit Sub
            End If

            If SetString(ds.Tables(0).Rows(BindingContext(ds.Tables(0)).Position).Item("pb_status_inv_issue")) = "X" Then
                MessageBox.Show("Data already reject..", "Information", MessageBoxButtons.OK, MessageBoxIcon.Information)

                Exit Sub
            End If

            'pb_status_inv_issue
            Dim frm As New FUpdateEntityShipment


            dt_bantu = New DataTable
            dt_bantu = (func_data.load_en_mstr_tran())
            frm.pb_en_id.Properties.DataSource = dt_bantu
            frm.pb_en_id.Properties.DisplayMember = dt_bantu.Columns("en_desc").ToString
            frm.pb_en_id.Properties.ValueMember = dt_bantu.Columns("en_id").ToString
            frm.pb_en_id.ItemIndex = 0


            dt_bantu = New DataTable
            dt_bantu = (func_data.load_en_mstr_all())
            frm.pb_en_id_shipment.Properties.DataSource = dt_bantu
            frm.pb_en_id_shipment.Properties.DisplayMember = dt_bantu.Columns("en_desc").ToString
            frm.pb_en_id_shipment.Properties.ValueMember = dt_bantu.Columns("en_id").ToString
            frm.pb_en_id_shipment.ItemIndex = 0

            frm.pb_en_id.EditValue = ds.Tables(0).Rows(BindingContext(ds.Tables(0)).Position).Item("pb_en_id")

            Dim ssql As String = ""
            ssql = "SELECT  false as pilih," _
                    & "  public.en_mstr.en_desc,public.en_mstr.en_code, " _
                    & "  public.pb_mstr.pb_oid, " _
                    & "  public.pb_mstr.pb_dom_id, " _
                    & "  public.pb_mstr.pb_en_id, " _
                    ...
                    & "  LEFT OUTER JOIN public.pbt_type ON (public.pb_mstr.pb_pbt_code = public.pbt_type.pbt_code) " _
                    & "  LEFT OUTER JOIN public.en_mstr en_mstr_shipment ON (pb_en_id_shipment = en_mstr_shipment.en_id) " _
                    & " where pb_oid= " + SetSetring(ds.Tables(0).Rows(BindingContext(ds.Tables(0)).Position).Item("pb_oid")) + ""

            Dim dt_pb As New DataTable
            dt_pb = GetTableData(ssql)

            For Each dr_pb As DataRow In dt_pb.Rows
                frm.pb_en_id_shipment.EditValue = dr_pb("pb_en_id_shipment")
                frm._en_id_asal = SetNumber(dr_pb("pb_en_id_shipment"))
                frm._en_desc_asal = SetString(dr_pb("en_desc_shipment"))
            Next


            frm.ptnr_detail.EditValue = ds.Tables(0).Rows(BindingContext(ds.Tables(0)).Position).Item("pb_rmks")

            frm._pb_oid = ds.Tables(0).Rows(BindingContext(ds.Tables(0)).Position).Item("pb_oid").ToString
            frm._pb_code = ds.Tables(0).Rows(BindingContext(ds.Tables(0)).Position).Item("pb_code")

            frm._sq_code = SetString(ds.Tables(0).Rows(BindingContext(ds.Tables(0)).Position).Item("pb_requested"))
           
            frm._customer = SetString(ds.Tables(0).Rows(BindingContext(ds.Tables(0)).Position).Item("pb_end_user")) 'pb_end_user

            If SetString(ds.Tables(0).Rows(BindingContext(ds.Tables(0)).Position).Item("pb_requested")).Substring(0, 2) <> "SQ" Then
                Box("SQ number error")
                Exit Sub
            End If
