...
Public Class XRInventoryReqPrint
    ...
    Private Sub XRInventoryReqPrint_AfterPrint(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.AfterPrint
        'set_paper()
    End Sub

    Private Sub XRInventoryReqPrint_BeforePrint(ByVal sender As Object, ByVal e As System.Drawing.Printing.PrintEventArgs) Handles Me.BeforePrint
            ...
            Using objcb As New master_new.WDABasepgsql("", "")
                With objcb
                    .SQL = "SELECT  " _
                            ...
                            & " and paper_en_id = " & GetCurrentColumnValue("pb_en_id").ToString _
                    ...
                    Try
                        ...
                        If _available = False Then
                            ...
                            .Command.CommandText = "INSERT INTO  " _
                                            ...
                                            & SetInteger(GetCurrentColumnValue("pb_en_id").ToString) & "," _
