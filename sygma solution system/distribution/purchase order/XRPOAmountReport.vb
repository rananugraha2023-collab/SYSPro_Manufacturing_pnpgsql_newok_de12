...
Public Class XRPOAmountReport

    Private Sub XRPOAmountReport_BeforePrint(ByVal sender As Object, ByVal e As System.Drawing.Printing.PrintEventArgs) Handles Me.BeforePrint
        Try
            Dim ssql As String
    ...
    Private Sub Detail_BeforePrint(ByVal sender As Object, ByVal e As System.Drawing.Printing.PrintEventArgs) Handles Detail.BeforePrint
        Try
            ...
            If GetCurrentColumnValue("status") = "True" Then
                ssql = "SELECT  " _
                    ...
                    & " where po_date >= " + SetDate(GetCurrentColumnValue("tgl_awal")) _
                    & " and po_date <= " + SetDate(GetCurrentColumnValue("tgl_akhir")) _
                    & " and po_en_id in (select user_en_id from tconfuserentity " _
                               & " where userid = " + master_new.ClsVar.sUserID.ToString + ") and pod_pt_id=" & SetInteger(GetCurrentColumnValue("pod_pt_id"))


                Dim ds_sub_report As New DataSet
                ds_sub_report = ReportDataset(ssql)

                Dim rpt1 As New XRPOAmountReportSub
