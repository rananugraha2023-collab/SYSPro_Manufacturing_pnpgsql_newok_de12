Public Class FPurchaseReceiptQRPrint
    Public dt_bantu As DataTable
    Public func_data As New function_data

    Private Sub FPurchaseReceiptQRPrint_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
    ...
    Private Sub rcv_be_id_ButtonClick(ByVal sender As Object, ByVal e As DevExpress.XtraEditors.Controls.ButtonPressedEventArgs) Handles rcv_be_id.ButtonClick
        Dim frm As New FPurchaseReceiptSearchQR()
        frm.set_win(Me)
        frm._en_id = le_entity.EditValue
        frm._obj = rcv_be_id
        frm._obk = rcv_cly_qty
        frm.type_form = True
        frm.ShowDialog()
    End Sub
    ...
    Public Overrides Sub preview()
        ...
        _table = "rcv_mstr"
        _initial = "rcv"
        _code_awal = Trim(rcv_be_id.Text)
        ...
        _sql = "SELECT  " _
            ...
            & "    where rcv_code >= '" + rcv_be_id.Text + "'" _
            & "    order by rcv_code"

        Dim frm As New frmPrintDialog
        frm._ssql = _sql
        If ce_qrcode.EditValue = True Then
