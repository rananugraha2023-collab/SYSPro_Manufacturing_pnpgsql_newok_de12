...
Public Class XRPurchaseOrderPrintOutNoCost_ex
    ...
    Private Sub XRPurchaseOrderPrintOutNoCost_AfterPrint(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.AfterPrint
        'set_paper()
    End Sub
