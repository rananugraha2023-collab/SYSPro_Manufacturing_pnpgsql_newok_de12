...
Public Class XRPurchaseReceiptPrint
    ...
    Private Sub XRPurchaseReceiptPrint_AfterPrint(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.AfterPrint
        'set_paper()
    End Sub

    Private Sub XRPurchaseReceiptPrint_BeforePrint(ByVal sender As Object, ByVal e As System.Drawing.Printing.PrintEventArgs) Handles Me.BeforePrint
            ...
            Using objcb As New master_new.WDABasepgsql("", "")
                With objcb
                    .SQL = "SELECT  " _
                            ...
                            & " and paper_en_id = " & GetCurrentColumnValue("rcv_en_id").ToString _
                    ...
                    Try
                        ...
                        If _available = False Then
                            ...
                            .Command.CommandText = "INSERT INTO  " _
                                            ...
                                            & SetInteger(GetCurrentColumnValue("rcv_en_id").ToString) & "," _
    ...
    Private Sub Detail_BeforePrint(ByVal sender As Object, ByVal e As System.Drawing.Printing.PrintEventArgs) Handles Detail.BeforePrint
        ...
        Try
            sSQL = "SELECT  " _
                ...
                & "  public.cmt_mstr a " _
                & "WHERE " _
                & "  a.cmt_ref_oid = '" & GetCurrentColumnValue("rcvd_pod_oid").ToString & "'"

            Dim ds As New DataSet
            ds = master_new.PGSqlConn.ReportDataset(sSQL) 'ReportDataset(sSQL)
