...
Public Class FPurchaseReceiptReport
    ...
    Public Overrides Sub format_grid()
        ...
        add_column_copy(gv_view1, "Qty Receipt", "rcvd_qty", DevExpress.Utils.HorzAlignment.Default, DevExpress.Utils.FormatType.Numeric, "n")
            ...
            Try
                ...
                Using objload As New master_new.WDABasepgsql("", "")
                    With objload
                        ...
                        If CeNoInvoice.EditValue = True Then
                            .SQL = "SELECT  " _
                        ...
                        Else
                            ...
                            & "ap_type_master.code_name as type_name,cc_desc, " _
                            & "tax_class_master.code_name as tax_class_name " _
                            & "FROM " _
                            & "public.rcv_mstr " _
                            & "INNER JOIN public.po_mstr ON (public.rcv_mstr.rcv_po_oid = public.po_mstr.po_oid) " _
