...
Public Class FSalesOrderSDI
    ...
    Public Overrides Sub load_cb()
        ...
        dt_bantu = New DataTable
        dt_bantu = (func_data.load_va_mstr())
        so_va_id.Properties.DataSource = dt_bantu
        so_va_id.Properties.DisplayMember = dt_bantu.Columns("va_name").ToString
        so_va_id.Properties.ValueMember = dt_bantu.Columns("va_id").ToString
        so_va_id.ItemIndex = 0
    ...
    Public Overrides Function get_sequel() As String
        get_sequel = "SELECT  " _
                    ...
                    & "  end as so_ppn_type,so_sq_ref_oid, " _
                    ...
                    & "  inner join va_mstr on va_id = so_va_id " _
                    ...
                    & "  left outer join sq_mstr on sq_oid = so_sq_ref_oid " _
...
#End Region
                ...
                With objinsert
                    ...
                    Try
                        ...
                        .Command.CommandText = "UPDATE  " _
                                            & "  public.va_mstr   " _
                                            & "SET  " _
                                            & "  va_ptnr_id = " & _so_ptnr_id_sold_mstr & "  " _
                                            & "WHERE  " _
                                            & "  va_id = " & SetInteger(so_va_id.EditValue) & " "
                        ssqls.Add(.Command.CommandText)
                        .Command.ExecuteNonQuery()
                        .Command.Parameters.Clear()
                        ...
                        .Command.CommandText = "INSERT INTO  " _
                                            ...
                                            & SetInteger(so_va_id.EditValue) & ",  " _
                                            & SetDbl(_total_dp) & ",  " _
                                            & SetDbl(0) & ",  " _
                                            & SetDbl(_so_total) & ",  " _
                        ...
                        For i = 0 To ds_edit.Tables(0).Rows.Count - 1
                            ...
                            .Command.CommandType = CommandType.Text
                            .Command.CommandText = "update sq_mstr set sq_trans_id = 'C' " + _
                            ...
                            'Update sqd_det
                            ' '' ''.Command.CommandType = CommandType.Text
                            ' '' ''.Command.CommandText = "update sqd_det set sqd_qty_picked = coalesce(sqd_qty_picked,0) + " + SetDbl(ds_edit.Tables(0).Rows(i).Item("sod_qty")) _
                            ' '' ''                     & " where sqd_oid = '" + SetSetring(ds_edit.Tables(0).Rows(i).Item("sod_sqd_oid").ToString) + "'"
                            ' '' ''ssqls.Add(.Command.CommandText)
                            ' '' ''.Command.ExecuteNonQuery()
                            ' '' ''.Command.Parameters.Clear()

                            ' '' ''.Command.CommandType = CommandType.Text
                            ' '' ''.Command.CommandText = "update sqd_det set sqd_status = 'c'" _
                            ' '' ''                     & " where sqd_oid = '" + ds_edit.Tables(0).Rows(i).Item("sod_sqd_oid").ToString + "'" _
                            ' '' ''                     & " and sqd_qty = sqd_qty_picked "
                            ' '' ''ssqls.Add(.Command.CommandText)
                            ' '' ''.Command.ExecuteNonQuery()
                            ' '' ''.Command.Parameters.Clear()
                        ...
                        'Untuk update sq_close_date apabile semua line sudah terpenuhi qty_pickednya...
                        .Command.CommandType = CommandType.Text
                        .Command.CommandText = "update sq_mstr set sq_close_date = " & SetDateNTime00(so_date.DateTime) & "" + _
                                               " where coalesce((select count(sqd_sq_oid) as jml From sqd_det " + _
                                               " where sqd_qty <> coalesce(sqd_qty_picked,0) " + _
                                               " and sqd_sq_oid = '" + _sq_oid.ToString + "'" + _
                                               " group by sqd_sq_oid),0) = 0 " + _
                                               " and sq_oid = '" + _sq_oid.ToString + "'"
                        ssqls.Add(.Command.CommandText)
                        .Command.ExecuteNonQuery()
                        .Command.Parameters.Clear()
    ...
    Public Overrides Function edit_data() As Boolean
        ...
        If MyBase.edit_data = True Then
            ...
            With ds.Tables(0).Rows(row)
                ...
                so_va_id.EditValue = .Item("so_va_id")
                ...
                With objinsert
                    ...
                    Try
                        ...
                        .Command.CommandText = "UPDATE  " _
                                            ...
                                            & "  so_va_id = " & SetInteger(so_va_id.EditValue) & ",  " _
                    ...
                    With objinsert
                        ...
                        Try
                            ...
                            .Command.CommandText = "update sq_mstr set sq_trans_id = 'I' " + _
                                                   " where sq_oid = '" + ds.Tables(0).Rows(BindingContext(ds.Tables(0)).Position).Item("so_sq_ref_oid").ToString + "'"
    ...
    Public Overrides Sub cancel_line()
        ...
        '                .Command.CommandType = CommandType.Text
        '                .Command.CommandText = "update sq_mstr set sq_trans_id = 'I' " + _
        '                                       " where sq_oid = '" + ds.Tables(0).Rows(BindingContext(ds.Tables(0)).Position).Item("so_sq_ref_oid") + "'"
    ...
    Private Sub so_ptnr_id_sold_EditValueChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles so_ptnr_id_sold.EditValueChanged

    End Sub


    Private Sub so_ref_sq_code_ButtonClick(ByVal sender As Object, ByVal e As DevExpress.XtraEditors.Controls.ButtonPressedEventArgs) Handles so_ref_sq_code.ButtonClick
