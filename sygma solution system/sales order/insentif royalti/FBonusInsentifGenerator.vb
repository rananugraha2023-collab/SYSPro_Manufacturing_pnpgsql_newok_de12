...
Public Class FBonusInsentifGenerator
    ...
    Public Overrides Sub insert_data_awal()
        ...
        geninstf_ce_simulated.EditValue = True
                ...
                With objinsert
                    ...
                    Try
                        ...
                        .Command.CommandText = "INSERT INTO public.geninstf_mstr " _
                                            ...
                                            & SetBitYN(geninstf_ce_simulated.EditValue) & ", " _
                        ...
                        'If SetString(genfsn_qrtr_id.Text) <> "" Then
                        ...
                        If SetBitYN(geninstf_ce_simulated.EditValue) = "N" Then
                            .Command.CommandType = CommandType.Text
                            .Command.CommandText = "update genfsn_mstr set genfsn_ce_final = 'Y', genfsn_ce_date = " & SetDateNTime(master_new.PGSqlConn.CekTanggal) & " " + _
                                                   " where genfsn_oid = " & SetSetring(geninstf_fsn_oid.Tag) & " "
    ...
    Public Overrides Function before_delete() As Boolean
        ...
        Try
            Using objcb As New master_new.WDABasepgsql("", "")
                With objcb
                    .SQL = "SELECT geninstf_ce_simulated FROM geninstf_mstr " & _
                           "WHERE geninstf_oid = '" & ds.Tables(0).Rows(BindingContext(ds.Tables(0)).Position).Item("geninstf_oid").ToString & "'"
                    .InitializeCommand()
                    .FillDataSet(ds_bantu, "geninstf_mstr")
                End With
            End Using
            ...
            If ds_bantu.Tables(0).Rows.Count > 0 Then
                ' Ambil nilai field
                Dim status As String = ds_bantu.Tables(0).Rows(0).Item("geninstf_ce_simulated").ToString().Trim()

                ' Jika status 'Y', batalkan penghapusan
                If status = "N" Then
                    MessageBox.Show("Can't Delete Final Data...", "Error", MessageBoxButtons.OK, MessageBoxIcon.Error)
                    Return False
                End If
            End If
