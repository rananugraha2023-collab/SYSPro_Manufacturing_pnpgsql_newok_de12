...
Public Class XRSalesOrderShipmentPrint
    ...
    Private Sub XRSalesOrderShipmentPrint_AfterPrint(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.AfterPrint
        'set_paper()
    End Sub

    Private Sub XRSalesOrderShipmentPrint_BeforePrint(ByVal sender As Object, ByVal e As System.Drawing.Printing.PrintEventArgs) Handles Me.BeforePrint
