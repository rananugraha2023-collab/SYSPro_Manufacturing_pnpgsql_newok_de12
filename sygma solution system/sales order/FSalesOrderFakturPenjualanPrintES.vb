...
Public Class FSalesOrderFakturPenjualanPrintES

    Public dt_bantu As DataTable
    Public func_data As New function_data
    Dim _now, _before, _then As DateTime

    Private Sub FSalesOrderFakturPenjualanPrintES_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        so_en_id_shipment.Properties.DataSource = dt_bantu
        so_en_id_shipment.Properties.DisplayMember = dt_bantu.Columns("en_desc").ToString
        so_en_id_shipment.Properties.ValueMember = dt_bantu.Columns("en_id").ToString
        so_en_id_shipment.ItemIndex = 0
        ...
        CheckEditNew.EditValue = True
        ce_prn_dt.EditValue = True
    ...
    Private Sub be_first_ButtonClick(ByVal sender As Object, ByVal e As DevExpress.XtraEditors.Controls.ButtonPressedEventArgs) Handles be_first.ButtonClick
        ...
        frm.set_win(Me)
        frm._en_id = so_en_id_shipment.EditValue
    ...
    Public Overrides Sub preview()
        ...
        If ce_prn_dt.EditValue = True Then
            ...
            _sql = _sql + "  and so_en_id_shipment = " + so_en_id_shipment.EditValue.ToString + " "
        Else
            _sql = _sql + "WHERE "
    ...
    Private Sub so_tglcutting_awal_EditValueChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles so_tglcutting_awal.EditValueChanged
