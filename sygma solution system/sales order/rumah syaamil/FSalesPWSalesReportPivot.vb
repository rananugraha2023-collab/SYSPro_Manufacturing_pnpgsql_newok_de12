...
Public Class FSalesPWSalesReportPivot
    Dim dt_bantu As DataTable
    Dim func_data As New function_data
    Dim func_coll As New function_collection
    Dim _now As DateTime

    Private Sub FSalesPWSalesReport_Pivot_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
    ...
    Private Sub format_pivot()
        ...
        add_column_pivot(pgc_ar, "Entity", "en_desc", DevExpress.XtraPivotGrid.PivotArea.RowArea)
        add_column_pivot(pgc_ar, "Parent Name", "ptnr_name", DevExpress.XtraPivotGrid.PivotArea.RowArea)
        add_column_pivot(pgc_ar, "Partner Name", "ptnr_name", DevExpress.XtraPivotGrid.PivotArea.RowArea)
        add_column_pivot(pgc_ar, "Category", "ptnrc_name", DevExpress.XtraPivotGrid.PivotArea.RowArea)


        'add_column_pivot(pgc_ar, "Waqf Points ", "total_su", DevExpress.XtraPivotGrid.PivotArea.RowArea)

        'add_column_pivot(pgc_ar, "Year", "pb_date", DevExpress.XtraPivotGrid.PivotArea.FilterArea, DevExpress.XtraPivotGrid.PivotGroupInterval.DateYear, "soship_date_year")
        'add_column_pivot(pgc_ar, "Month", "pwgen_periode_code", DevExpress.XtraPivotGrid.PivotArea.DataArea, DevExpress.XtraPivotGrid.PivotGroupInterval.DateMonth, "soship_date_month")
        'add_column_pivot(pgc_ar, "Date", "pb_date", DevExpress.XtraPivotGrid.PivotArea.FilterArea, DevExpress.XtraPivotGrid.PivotGroupInterval.Date, "soship_date_date")
        add_column_pivot(pgc_ar, "Periode", "pwgen_periode_code", DevExpress.XtraPivotGrid.PivotArea.FilterArea)
        add_column_pivot(pgc_ar, "Parent", " ptnr_mstr1.ptnr_name", DevExpress.XtraPivotGrid.PivotArea.FilterArea)
        'add_column_pivot(pgc_ar, "Description1", "pt_desc1", DevExpress.XtraPivotGrid.PivotArea.FilterArea)
        'add_column_pivot(pgc_ar, "Description2", "pt_desc2", DevExpress.XtraPivotGrid.PivotArea.FilterArea)
        'add_column_pivot(pgc_ar, "End User", "pbd_end_user", DevExpress.XtraPivotGrid.PivotArea.FilterArea)
        add_column_pivot(pgc_ar, "Qty", "total_su", DevExpress.XtraPivotGrid.PivotArea.DataArea, DevExpress.Utils.FormatType.Numeric, "n")
    ...
    Private Function set_sql() As String
        ...
        set_sql = "SELECT public.pwgen_mstr.pwgen_en_id, " _
                & "       public.en_mstr.en_desc, " _
                & "       public.pwgen_mstr.pwgen_periode_code, " _
                & "       public.pwgend_det.pwgend_ptnr_id, " _
                & "       public.ptnr_mstr.ptnr_name, " _
                & "       public.ptnr_mstr.ptnr_ptnrc_id, " _
                & "       public.ptnrc_cat.ptnrc_name, " _
                & "       public.ptnr_mstr.ptnr_parent, " _
                & "       ( " _
                & "         SELECT x.ptnr_name " _
                & "         FROM ptnr_mstr x " _
                & "         WHERE x.ptnr_id = public.ptnr_mstr.ptnr_parent " _
                & "       ) AS parent_name, " _
                & "       public.pwgend_det.pwgend_rem_point, " _
                & "       SUM(public.pwgend_det.pwgend_ps_vol) AS field_1 " _
                & "FROM public.pwgen_mstr " _
                & "     INNER JOIN public.pwgend_det ON (public.pwgen_mstr.pwgen_oid = public.pwgend_det.pwgend_pwgen_oid) " _
                & "     INNER JOIN public.ptnr_mstr ON (public.pwgend_det.pwgend_ptnr_id = public.ptnr_mstr.ptnr_id) " _
                & "     INNER JOIN public.ptnrc_cat ON (public.ptnr_mstr.ptnr_ptnrc_id = public.ptnrc_cat.ptnrc_id) " _
                & "     INNER JOIN public.en_mstr ON (public.pwgen_mstr.pwgen_en_id = public.en_mstr.en_id) " _
                & "GROUP BY public.pwgen_mstr.pwgen_en_id, " _
                & "         public.en_mstr.en_desc, " _
                & "         public.pwgen_mstr.pwgen_periode_code, " _
                & "         public.pwgend_det.pwgend_ptnr_id, " _
                & "         public.ptnr_mstr.ptnr_name, " _
                ...
                & "         public.ptnrc_cat.ptnrc_name, " _
                & "         public.ptnr_mstr.ptnr_parent, " _
                & "         public.pwgend_det.pwgend_rem_point"
