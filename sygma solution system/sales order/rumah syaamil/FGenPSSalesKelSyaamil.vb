...
Public Class FGenPSSalesKelSyaamil
    ...
    Public Overrides Sub format_grid()
        ...
        add_column_copy(gv_edit, "ID", "psdgen_en_desc", DevExpress.Utils.HorzAlignment.Default)
        add_column_copy(gv_edit, "ID", "psgend_ptnr_id", DevExpress.Utils.HorzAlignment.Default)
        add_column_copy(gv_edit, "Sales Name", "psdgen_ptnr_name", DevExpress.Utils.HorzAlignment.Default)
        add_column_copy(gv_edit, "Level", "psdgen_lvl_name", DevExpress.Utils.HorzAlignment.Default)
        add_column_copy(gv_edit, "ID", "psgend_ptnr_parent", DevExpress.Utils.HorzAlignment.Default)
        add_column_copy(gv_edit, "Sales Name", "psdgen_ptnr_name_parent", DevExpress.Utils.HorzAlignment.Default)
        add_column_copy(gv_edit, "Personal Sales Amount", "psgend_penjualan_nilai", DevExpress.Utils.HorzAlignment.Far, DevExpress.Utils.FormatType.Numeric, "n", DevExpress.Data.SummaryItemType.Sum, "SUM={0:n}")
        add_column_copy(gv_edit, "Downline Sales Amount", "psgend_penjualan_nilai_downline", DevExpress.Utils.HorzAlignment.Far, DevExpress.Utils.FormatType.Numeric, "n", DevExpress.Data.SummaryItemType.Sum, "SUM={0:n}")
        add_column_copy(gv_edit, "Personal PR Amount", "psgend_penjualan_pr", DevExpress.Utils.HorzAlignment.Far, DevExpress.Utils.FormatType.Numeric, "n", DevExpress.Data.SummaryItemType.Sum, "SUM={0:n}")
        add_column_copy(gv_edit, "Group Sales Amount", "psgend_penjualan_nilai_grup", DevExpress.Utils.HorzAlignment.Far, DevExpress.Utils.FormatType.Numeric, "n")
        add_column_copy(gv_edit, "Group PR Amount", "psgend_penjualan_pr_grup", DevExpress.Utils.HorzAlignment.Far, DevExpress.Utils.FormatType.Numeric, "n")
        add_column_copy(gv_edit, "Total Sales Amount", "psgend_penjualan_nilai_nasional", DevExpress.Utils.HorzAlignment.Far, DevExpress.Utils.FormatType.Numeric, "n")
        add_column_copy(gv_edit, "Sales Commision", "psgend_komisi_penjualan", DevExpress.Utils.HorzAlignment.Far, DevExpress.Utils.FormatType.Numeric, "n", DevExpress.Data.SummaryItemType.Sum, "SUM={0:n}")
        add_column_copy(gv_edit, "Mentoring Commision", "psgend_komisi_mentoring", DevExpress.Utils.HorzAlignment.Far, DevExpress.Utils.FormatType.Numeric, "n", DevExpress.Data.SummaryItemType.Sum, "SUM={0:n}")
        add_column_copy(gv_edit, "Bonus Sharing", "psgend_bonus_sharing", DevExpress.Utils.HorzAlignment.Far, DevExpress.Utils.FormatType.Numeric, "n", DevExpress.Data.SummaryItemType.Sum, "SUM={0:n}")
        add_column_copy(gv_edit, "Total Income", "psgend_total_income", DevExpress.Utils.HorzAlignment.Far, DevExpress.Utils.FormatType.Numeric, "n", DevExpress.Data.SummaryItemType.Sum, "SUM={0:n}")
        ...
        add_column_copy(gv_detail, "Personal Vol Amount", "psgend_ps_vol", DevExpress.Utils.HorzAlignment.Far, DevExpress.Utils.FormatType.Numeric, "n", DevExpress.Data.SummaryItemType.Sum, "SUM={0:n}")
        add_column_copy(gv_detail, "Team Vol Amount", "psgend_pt_vol", DevExpress.Utils.HorzAlignment.Far, DevExpress.Utils.FormatType.Numeric, "n", DevExpress.Data.SummaryItemType.Sum, "SUM={0:n}")
        add_column_copy(gv_detail, "Child Count", "psgend_network_child", DevExpress.Utils.HorzAlignment.Far, DevExpress.Utils.FormatType.Numeric, "n")
        add_column_copy(gv_detail, "Child Level", "psgend_child_level", DevExpress.Utils.HorzAlignment.Default)
        add_column_copy(gv_detail, "Sales Amount", "psgend_sales_amount", DevExpress.Utils.HorzAlignment.Far, DevExpress.Utils.FormatType.Numeric, "n")
        add_column_copy(gv_detail, "Commision", "psgend_commision", DevExpress.Utils.HorzAlignment.Far, DevExpress.Utils.FormatType.Numeric, "n", DevExpress.Data.SummaryItemType.Sum, "SUM={0:n}")
        add_column_copy(gv_detail, "Network Bonus", "psgend_network_bonus", DevExpress.Utils.HorzAlignment.Far, DevExpress.Utils.FormatType.Numeric, "n", DevExpress.Data.SummaryItemType.Sum, "SUM={0:n}")
            ...
            Using objcb As New master_new.WDABasepgsql("", "")
                With objcb
                    .SQL = "SELECT  " _
                        ...
                        & "  psgend_lvl_id, " _
                        & "  psdgen_lvl_name, " _
                        & "  psgend_ptnr_parent, " _
                        & "  psdgen_ptnr_name_parent, " _
                        & "  psgend_seq, " _
                        & "  psgend_penjualan_nilai, psgend_penjualan_nilai_downline,psgend_penjualan_nilai_nasional, " _
                        & "  psgend_penjualan_pr, " _
                        & "  psgend_penjualan_nilai_grup, " _
                        & "  psgend_penjualan_pr_grup, " _
                        & "  psgend_komisi_penjualan, " _
                        & "  psgend_komisi_mentoring, " _
                        & "  psgend_bonus_sharing, " _
                        & "  psgend_total_income " _
                        & "FROM  " _
                        & "  public.psgendk_det where psgend_psgen_oid is null "
    ...
    Private Sub BtGen_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BtGen.Click
        Try
            ...
            sSQL = "select so_ptnr_id_bill, ptnr_code, ptnr_name, so_code, soship_date, soship_code, ptnr_parent, ptnr_name_parent, " _
                    & "en_desc, lvl_name, lvl_code, min(lvl_komisi_penjualan) as lvl_komisi_penjualan, min(lvl_komisi_mentoring) as lvl_komisi_mentoring,  " _
                    & "min(lvl_bonus_sharing) as lvl_bonus_sharing, sum(sales_unit) as sales_unit, sum(penjualan) as penjualan from ( " _
                    & "SELECT  " _
                    ...
                    & "	public.ptnr_mstr.ptnr_parent, " _
                    & "	ptnr_mstr1.ptnr_name AS ptnr_name_parent, " _
                    & "	en_desc, lvl_name,lvl_code,lvl_komisi_penjualan,lvl_komisi_mentoring,lvl_bonus_sharing, " _
                    & "	sod_sales_unit * sod_qty as sales_unit,sod_qty * sod_price as penjualan " _
                    & "FROM " _
                    ...
                    & "	INNER JOIN public.ptnr_mstr ptnr_mstr1 ON (ptnr_mstr1.ptnr_id = public.ptnr_mstr.ptnr_parent) " _
                    & "	INNER JOIN public.en_mstr ON (so_en_id = en_id) " _
                    & "	INNER JOIN public.pslvl_mstr ON (ptnr_mstr.ptnr_lvl_id = lvl_id) " _
                    & "WHERE " _
                    & "  public.ptnr_mstr.ptnr_is_ps = 'Y' and soship_date between " & SetDate(psgen_start_date.EditValue) _
                    & " and " & SetDate(psgen_end_date.EditValue) & ") as temp  " _
                    & " group by so_ptnr_id_bill, ptnr_code, ptnr_name, so_code, soship_date, soship_code, ptnr_parent, ptnr_name_parent, " _
                    & " en_desc, lvl_name, lvl_code order by so_ptnr_id_bill"

            Dim dt_penjualan As New DataTable
            dt_penjualan = GetTableData(sSQL)

            Dim _penjualan_nasional As Double = 0
            For Each dr_penjualan As DataRow In dt_penjualan.Rows
                _penjualan_nasional += SetNumber(dr_penjualan("penjualan"))
            Next

            sSQL = "SELECT  " _
                & "  a.ptnr_id, " _
                & "  a.ptnr_code, " _
                & "  a.ptnr_name, a.ptnr_parent, c.ptnr_name as ptnr_name_parent,a.ptnr_en_id,en_desc, " _
                & "  a.ptnr_lvl_id,lvl_name,lvl_code,lvl_komisi_penjualan,lvl_komisi_mentoring,lvl_bonus_sharing, " _
                & " 0.0 as psgend_penjualan_nilai, " _
                & " 0.0 as psgend_penjualan_pr, " _
                & " 0.0 as psgend_penjualan_nilai_grup, " _
                & " 0.0 as psgend_penjualan_pr_grup, " _
                & " 0.0 as psgend_komisi_penjualan, " _
                & " 0.0 as psgend_komisi_mentoring, " _
                & " 0.0 as psgend_bonus_sharing, " _
                & " 0.0 as psgend_total_income " _
                & "FROM " _
                & "  public.ptnr_mstr a " _
                & "  INNER JOIN public.pslvl_mstr b ON (a.ptnr_lvl_id = b.lvl_id) " _
                & "	INNER JOIN public.ptnr_mstr c ON (c.ptnr_id = a.ptnr_parent) " _
                & "	INNER JOIN public.en_mstr d ON (a.ptnr_en_id = d.en_id) " _
                & "WHERE " _
                & "  a.ptnr_is_ps = 'Y' and a.ptnr_is_cust='Y' AND a.ptnr_en_id=" & psgen_en_id.EditValue _
                & " AND a.ptnr_active = 'Y'  " _
                & " order by a.ptnr_name "
            ...
            For Each dr As DataRow In dt_fs.Rows
                ...
                _row("psgend_en_id") = dr("ptnr_en_id")
                _row("psdgen_en_desc") = dr("en_desc")
                _row("psgend_ptnr_id") = dr("ptnr_id")
                _row("psdgen_ptnr_name") = dr("ptnr_name")
                _row("psgend_lvl_id") = dr("ptnr_lvl_id")
                _row("psdgen_lvl_name") = dr("lvl_name")

                _row("psgend_ptnr_parent") = dr("ptnr_parent")
                _row("psdgen_ptnr_name_parent") = dr("ptnr_name_parent")

                Dim _data() As DataRow
                _data = dt_penjualan.Select("so_ptnr_id_bill=" & dr("ptnr_id") & "", "so_ptnr_id_bill", DataViewRowState.CurrentRows)

                _row("psgend_penjualan_nilai") = _data(0)("penjualan")
                _row("psgend_penjualan_pr") = _data(0)("sales_unit")

                sSQL = "select menu_id from get_all_child(" _
                        & dr("ptnr_id") _
                        & ")"

                dt_child = GetTableData(sSQL)

                Dim _nilai_penjualan As Double = 0
                Dim _nilai_pr As Double = 0
                For Each dr_child As DataRow In dt_child.Rows
                    _data = dt_penjualan.Select("so_ptnr_id_bill=" & dr_child(0) & "", "so_ptnr_id_bill", DataViewRowState.CurrentRows)
                    _nilai_penjualan += _data(0)("penjualan")
                    _nilai_pr += _data(0)("sales_unit")
                Next
                ...
                _row("psgend_penjualan_nilai_grup") = _nilai_penjualan
                _row("psgend_penjualan_pr_grup") = _nilai_pr

                sSQL = "select ptnr_id from ptnr_mstr inner join pslvl_mstr on ptnr_lvl_id=lvl_id  where ptnr_parent=" _
                      & dr("ptnr_id") _
                      & " and lvl_code='CS' "
                ...
                _row("psgend_penjualan_nilai_downline") = _nilai_penjualan
                _row("psgend_penjualan_nilai_nasional") = _penjualan_nasional

                _row("psgend_komisi_penjualan") = SetNumber(dr("lvl_komisi_penjualan") / 100) * SetNumber(_row("psgend_penjualan_nilai_downline"))
                _row("psgend_komisi_mentoring") = SetNumber(dr("lvl_komisi_mentoring") / 100) * SetNumber(_row("psgend_penjualan_nilai_grup"))
                _row("psgend_bonus_sharing") = SetNumber(dr("lvl_bonus_sharing") / 100) * SetNumber(_row("psgend_penjualan_nilai_nasional"))
                _row("psgend_total_income") = SetNumber(_row("psgend_komisi_penjualan")) + SetNumber(_row("psgend_komisi_mentoring")) _
                                        + SetNumber(_row("psgend_bonus_sharing"))
