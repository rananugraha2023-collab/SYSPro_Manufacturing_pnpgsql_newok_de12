...
Public Class FSalesVSTReport
    ...
    Private Sub FSalesVSTReport_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
    ...
    Public Overrides Sub format_grid()
        ...
        add_column_copy(gv_master, "Visite Date", "visite_startdate", DevExpress.Utils.HorzAlignment.Center, DevExpress.Utils.FormatType.DateTime, "d")
        add_column_copy(gv_master, "Visit Code", "visite_code", DevExpress.Utils.HorzAlignment.Default)
        add_column_copy(gv_master, "Sales Person", "ptnr_name", DevExpress.Utils.HorzAlignment.Default)
        add_column_copy(gv_master, "Visit is Planned", "visite_is_planned", DevExpress.Utils.HorzAlignment.Default)
        add_column_copy(gv_master, "Plans Code", "plans_code", DevExpress.Utils.HorzAlignment.Default)
        add_column_copy(gv_master, "Periode", "plans_periode", DevExpress.Utils.HorzAlignment.Center, DevExpress.Utils.FormatType.DateTime, "G")

        'add_column_copy(gv_master, "Type", "visite_type", DevExpress.Utils.HorzAlignment.Default)
        'add_column_copy(gv_master, "Visite Date", "visite_enddate", DevExpress.Utils.HorzAlignment.Center, DevExpress.Utils.FormatType.DateTime, "G")
        'add_column_copy(gv_master, "Start", "visited_check_in", DevExpress.Utils.HorzAlignment.Center, DevExpress.Utils.FormatType.DateTime, "G")
        'add_column_copy(gv_view1, "Chekin", "visited_address_gps_check_in", DevExpress.Utils.HorzAlignment.Default)
        'add_column_copy(gv_master, "End", "visited_check_out", DevExpress.Utils.HorzAlignment.Center, DevExpress.Utils.FormatType.DateTime, "G")
        'add_column_copy(gv_view1, "Chek Out", "visited_address_gps_check_out", DevExpress.Utils.HorzAlignment.Default)
        'add_column_copy(gv_master, "Duration", "duration", DevExpress.Utils.HorzAlignment.Default)
        'add_column_copy(gv_master, "Output", "visite_output", DevExpress.Utils.HorzAlignment.Default)
        'add_column_copy(gv_master, "Result", "visited_Result", DevExpress.Utils.HorzAlignment.Default)

        add_column(gv_detail, "visited_visite_oid", False)
        add_column_copy(gv_detail, "Partner Name", "visited_cus_name", DevExpress.Utils.HorzAlignment.Default)
        add_column_copy(gv_detail, "Cek In", "visited_check_in", DevExpress.Utils.HorzAlignment.Far, DevExpress.Utils.FormatType.Numeric, "n")
        add_column_copy(gv_detail, "Cek in Address", "visited_address_gps_check_in", DevExpress.Utils.HorzAlignment.Default)
        add_column_copy(gv_detail, "Cek Out", "visited_check_out", DevExpress.Utils.HorzAlignment.Far, DevExpress.Utils.FormatType.Numeric, "n")
        add_column_copy(gv_detail, "Cek out Address", "visited_address_gps_check_out", DevExpress.Utils.HorzAlignment.Default)
        add_column_copy(gv_detail, "Duration", "duration", DevExpress.Utils.HorzAlignment.Far, DevExpress.Utils.FormatType.Numeric, "n")
        add_column_copy(gv_detail, "Type", "visite_type", DevExpress.Utils.HorzAlignment.Default)
        add_column_copy(gv_detail, "Output", "visite_output", DevExpress.Utils.HorzAlignment.Default)
        add_column_copy(gv_detail, "Result", "visited_result", DevExpress.Utils.HorzAlignment.Default)
        'add_column_copy(gv_detail, "Sisipan Trans visited_status", "hppr_tambahan_sisipan", DevExpress.Utils.HorzAlignment.Far, DevExpress.Utils.FormatType.Numeric, "n")
        ...
        'add_column_copy(gv_master, "Plans Code", "plans_code", DevExpress.Utils.HorzAlignment.Default)
        'add_column_copy(gv_master, "Periode", "plans_periode", DevExpress.Utils.HorzAlignment.Center, DevExpress.Utils.FormatType.DateTime, "G")
        'add_column_copy(gv_master, "Visite Date", "visite_startdate", DevExpress.Utils.HorzAlignment.Center, DevExpress.Utils.FormatType.DateTime, "G")
        'add_column_copy(gv_master, "Type", "visite_type", DevExpress.Utils.HorzAlignment.Default)
        ...
        'add_column_copy(gv_master, "Print Dat", "", DevExpress.Utils.HorzAlignment.Center, DevExpress.Utils.FormatType.DateTime, "G")
        'add_column_copy(gv_master, "SPH Code", "sph_code", DevExpress.Utils.HorzAlignment.Default)

        'add_column(gv_detail, "hppr_oid", False)
        'add_column_copy(gv_detail, "Part Number", "pt_code", DevExpress.Utils.HorzAlignment.Default)
        'add_column_copy(gv_detail, "Description1", "hppr_nama_produk", DevExpress.Utils.HorzAlignment.Default)
...
#Region "SQL"
    Public Overrides Function get_sequel() As String
        ...
        '            & "  public.hppr_mstr.hppr_tgl_order " _
        '            & "FROM " _
        '            & "  public.hppr_mstr " _
        '            & "  INNER JOIN public.en_mstr ON (public.hppr_mstr.hppr_en_id = public.en_mstr.en_id) " _
        '            & "  INNER JOIN public.ptnr_mstr ON (public.hppr_mstr.hppr_sales_id = public.ptnr_mstr.ptnr_id) " _
        '            & " where hppr_tgl_order >= " + SetDate(pr_txttglawal.DateTime.Date) + "" _
        '            & " and hppr_tgl_order <= " + SetDate(pr_txttglakhir.DateTime.Date) + "" _
        '            & " and hppr_en_id in (select user_en_id from tconfuserentity " _
        ...
        '                            & "  public.en_mstr.en_desc, " _
        '                            & "  public.visite_mstr.visite_oid, " _
        '                            & "  public.visite_mstr.visite_code, " _
        '                            & "  public.visite_mstr.visite_sales_id, " _
        '                            & "  public.ptnr_mstr.ptnr_code, " _
        '                            & "  public.ptnr_mstr.ptnr_name, " _
        '                            & "  public.visite_mstr.visite_plans_oid, " _
        '                            & "  public.visite_mstr.visite_is_planned, " _
        '                            & "  public.visite_mstr.visite_startdate, " _
        '                            & "  public.visite_mstr.visite_enddate, " _
        '                            & "  public.visite_mstr.visite_status, " _
        '                            & "  public.visite_mstr.visite_add_date, " _
        '                            & "  public.visite_mstr.visite_add_by, " _
        '                            & "  public.visite_mstr.visite_upd_date, " _
        '                            & "  public.visite_mstr.visite_upd_by " _
        '                            & "FROM " _
        '                            & "  public.visite_mstr " _
        '                            & "  INNER JOIN public.en_mstr ON (public.visite_mstr.visite_en_id = public.en_mstr.en_id) " _
        '                            & "  INNER JOIN public.ptnr_mstr ON (public.visite_mstr.visite_sales_id = public.ptnr_mstr.ptnr_id) " _
        '                            & " where visite_add_date >= " + SetDate(pr_txttglawal.DateTime.Date) _
        '                            & " and visite_add_date <= " + SetDate(pr_txttglakhir.DateTime.Date) _
        '                            & " and visite_en_id in (select user_en_id from tconfuserentity " _
        '                            & " where userid = " + master_new.ClsVar.sUserID.ToString + ") " _
        '                            & " order by visite_startdate "
        ...
        get_sequel = "SELECT  " _
                                    ...
                                    & "  INNER JOIN public.ptnr_mstr ON (public.visite_mstr.visite_sales_id = public.ptnr_mstr.ptnr_id) " _
                                    & " where " _
                                    & " visite_en_id in (select user_en_id from tconfuserentity " _
                                    & " where userid = " + master_new.ClsVar.sUserID.ToString + ") " _
                                                        & "  and visite_mstr.visite_startdate >= " + SetDate(pr_txttglawal.DateTime.Date) _
                    & "  and visite_mstr.visite_startdate <= " + SetDate(pr_txttglakhir.DateTime.Date) _
                                    & " order by visite_startdate "
        Return get_sequel
    End Function
    ...
    Private Sub load_data_to_detail()
        ...
        '    & "FROM " _
        '    & "  public.hppr_mstr " _
        '    & "  INNER JOIN public.pt_mstr ON (public.hppr_mstr.hppr_pt_id = public.pt_mstr.pt_id) " _
        '    & "  where public.hppr_mstr.hppr_oid = '" & ds.Tables(0).Rows(BindingContext(ds.Tables(0)).Position).Item("hppr_oid").ToString & "'"

        'load_data_detail(sql, gc_detail, "detail")

        sql = "SELECT  " _
                    & "  public.visited_detail.visited_oid, " _
                     & "  public.visited_detail.visited_visite_oid, " _
                    & "  public.visited_detail.visited_visite_code, " _
                    & "  public.visited_detail.visited_cus_name, " _
                    & "  public.visited_detail.visited_check_in, " _
                    & "  public.visited_detail.visited_address_gps_check_in, " _
                    & "  public.visited_detail.visited_check_out, " _
                    & "  public.visited_detail.visited_address_gps_check_out, " _
                    & "  (visited_check_out - visited_check_in) as duration, " _
                    & "  public.visited_detail.visited_visite_type, " _
                    & "  visite_type.code_name AS visite_type, " _
                    & "  public.visited_detail.visited_visite_output, " _
                    & "  visite_output.code_name AS visite_output, " _
                    & "  public.visited_detail.visited_result, " _
                    & "  public.visited_detail.visited_status " _
                    & "FROM " _
                    & "  public.visited_detail " _
                    & "  INNER JOIN public.code_mstr ON (public.visited_detail.visited_visite_type = public.code_mstr.code_id) " _
                    & "  LEFT OUTER JOIN code_mstr visite_type on visite_type.code_id = visited_visite_type " _
                    & "  LEFT OUTER JOIN code_mstr visite_output on visite_output.code_id = visited_visite_output " _
                    & " where visited_visite_oid = '" & ds.Tables(0).Rows(BindingContext(ds.Tables(0)).Position).Item("visite_oid").ToString & "'"
...
#End Region
    ...
    '    pwsr_en_id.Focus()
    '    pwsr_en_id.ItemIndex = 0
    '    pwsr_date.DateTime = Now
    '    pwsr_due_date.DateTime = Now
    '    pwsr_requested.Text = ""
    '    pwsr_end_user.Text = ""
    '    pwsr_rmks.Text = ""
    '    pwsr_tran_id.ItemIndex = 0
    ...
    '        _pb_code = func_coll.get_transaction_number("IR", pwsr_en_id.GetColumnValue("en_code"), "pb_mstr", "pb_code")

    '        If _conf_value = "1" Then
    '            ds_bantu = func_data.load_aprv_mstr(pwsr_tran_id.EditValue)
    '        End If

    '        '=============================================================================

    '        _pb_trn_id = pwsr_tran_id.EditValue
    ...
    '                                            & SetInteger(pwsr_en_id.EditValue) & ",  " _
    '                                            & SetSetring(master_new.ClsVar.sNama) & ", " _
    '                                            & " " & SetDateNTime(master_new.PGSqlConn.CekTanggal) & " " & ", " _
    '                                            & SetSetring(_pb_code) & ",  " _
    '                                            & SetDate(pwsr_date.DateTime) & ",  " _
    '                                            & SetDate(pwsr_due_date.DateTime) & ",  " _
    '                                            & SetSetring(pwsr_requested.Text) & ",  " _
    '                                            & SetSetring(pwsr_end_user.Text) & ",  " _
    '                                            & SetSetring(pwsr_rmks.Text) & ",  " _
    '                                            & SetInteger(pwsr_tran_id.EditValue) & ",  " _
    '                                            & SetSetring(_pb_trn_satatus) & ",  " _
    '                                            & SetSetring(pwsr_rwd_code.EditValue) & ",  " _
    '                                            & SetInteger(pwsr_en_id_shipment.EditValue) & ",  " _
    '                                            & "" & SetDateNTime(master_new.PGSqlConn.CekTanggal) & "" & "  " _
    '                                            & ")"
    ...
    '                                                        & SetInteger(master_new.ClsVar.sdom_id) & ",  " _
    '                                                        & SetInteger(pwsr_en_id.EditValue) & ",  " _
    '                                                        & SetSetring(pwsr_tran_id.EditValue) & ",  " _
    '                                                        & SetSetring(_pb_oid.ToString) & ",  " _
    '                                                        & SetSetring(_pb_code) & ",  " _
    ...
    '                End If
    '            End If
    '            If Not gv_detail.GetRowCellValue(i, "pbd_qty_riud") Is System.DBNull.Value Then
    '                If gv_detail.GetRowCellValue(i, "pbd_qty_riud") > 0 Then
    '                    MessageBox.Show("Data already processed..", "Information", MessageBoxButtons.OK, MessageBoxIcon.Information)
    '                    Return False
    '                    Exit Function
    '                End If
    ...
    '                pwsr_en_id.EditValue = .Item("pb_en_id")
    '                pwsr_rwd_code.EditValue = .Item("pb_pbt_code")
    '                pwsr_date.DateTime = .Item("pb_date")
    '                pwsr_due_date.DateTime = .Item("pb_due_date")
    '                pwsr_requested.Text = SetString(.Item("pb_requested"))
    '                pwsr_end_user.Text = SetString(.Item("pb_end_user"))
    '                pwsr_rmks.Text = SetString(.Item("pb_rmks"))
    '                pwsr_tran_id.EditValue = .Item("pb_tran_id")
    '                pwsr_en_id_shipment.EditValue = .Item("pb_en_id_shipment")
    '            End With
    '            pwsr_en_id.Focus()
    ...
    '                                            & "  public.pb_mstr   " _
    '                                            & "SET  " _
    '                                            & "  pb_dom_id = " & SetInteger(master_new.ClsVar.sdom_id) & ",  " _
    '                                            & "  pb_en_id = " & SetInteger(pwsr_en_id.EditValue) & ",  " _
    '                                            & "  pb_en_id_shipment = " & SetInteger(pwsr_en_id_shipment.EditValue) & ",  " _
    '                                            & "  pb_upd_by = " & SetSetring(master_new.ClsVar.sNama) & ",  " _
    '                                            & "  pb_upd_date = " & SetDateNTime(master_new.PGSqlConn.CekTanggal) & ",  " _
    '                                            & "  pb_date = " & SetDate(pwsr_date.DateTime) & ",  " _
    '                                            & "  pb_due_date = " & SetDate(pwsr_due_date.DateTime) & ",  " _
    '                                            & "  pb_requested = " & SetSetringDB(pwsr_requested.Text) & ",  " _
    '                                            & "  pb_end_user = " & SetSetringDB(pwsr_end_user.Text) & ",  " _
    '                                            & "  pb_rmks = " & SetSetringDB(pwsr_rmks.Text) & ",  " _
    '                                            & "  pb_tran_id = " & SetInteger(pwsr_tran_id.EditValue) & ",  " _
    '                                            & "  pb_trans_id = " & SetSetring(_pb_trn_satatus) & ",  " _
    '                                            & "  pb_pbt_code = " & SetSetringDB(pwsr_rwd_code.EditValue) & ",  " _
    ...
    '        With gv_edit
    '            .SetRowCellValue(e.RowHandle, "pbd_en_id", pwsr_en_id.EditValue)
    '            .SetRowCellValue(e.RowHandle, "en_desc", pwsr_en_id.GetColumnValue("en_desc"))
    '            .SetRowCellValue(e.RowHandle, "pbd_end_user", Trim(pwsr_end_user.Text))
    '            .SetRowCellValue(e.RowHandle, "pbd_qty", 0)
    '            .SetRowCellValue(e.RowHandle, "pbd_due_date", pwsr_due_date.DateTime)
    '            .BestFitColumns()
    '        End With
    '    End Sub
    '#End Region
    ...
    '    Private Sub pwsr_ptnr_id_ButtonClick(ByVal sender As Object, ByVal e As DevExpress.XtraEditors.Controls.ButtonPressedEventArgs) Handles pwsr_ptnr_id.ButtonClick
    '        Dim frm As New FPartnerSearch
    '        frm.set_win(Me)
    '        frm._en_id = pwsr_en_id.EditValue
    '        frm.type_form = True
    '        frm.ShowDialog()
    '    End Sub
    ...
    '                dr("pbd_en_id") = pwsr_en_id.EditValue
    '                dr("en_desc") = pwsr_en_id.Text
    '            Next
    '            ds_edit.AcceptChanges()
    '            Box("Success")
    '        Catch ex As Exception
