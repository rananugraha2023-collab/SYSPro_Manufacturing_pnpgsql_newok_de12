...
Public Class FSalesOrderReportSDQ
    Dim dt_bantu As DataTable
    Dim func_data As New function_data
    Dim func_coll As New function_collection
    Dim _now As DateTime

    Private Sub FSalesOrderReportSDQ_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        form_first_load()
    ...
    Private Sub grid_detail()
        ...
        add_column_copy(gv_detail, "Sales Unit Total", "so_sales_unit", DevExpress.Utils.HorzAlignment.Default)
    ...
    Private Sub load_detail(ByVal par_obj As Object)
        With par_obj
            .SQL = "SELECT  " _
                    ...
                    & "  sod_commision, " _
                    & "  (sod_commision * (sod_sales_unit * sod_qty)) as so_commision, " _
                    & "  sod_loc_id, " _
                    & "  sod_serial, " _
                    & "  en_desc, " _
                    & "  si_desc, " _
    ...
    Private Function set_sql() As String
        set_sql = "SELECT  " _
                    ...
                    & "bill_mstr.ptnr_name as bill_name, ptnrg_name, ptnrc_name, " _
                    & "so_date, " _
                    & "en_desc, " _
                    & "rate_ppn, " _
                    & "rate_pph, " _
