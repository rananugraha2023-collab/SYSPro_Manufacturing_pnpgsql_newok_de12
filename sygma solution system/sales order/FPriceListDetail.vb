...
Public Class FPriceListDetail
    ...
    Public Overrides Sub format_grid()
        ...
        add_column_copy(gv_detail_rule, "Commision", "pidd_commision", DevExpress.Utils.HorzAlignment.Default, DevExpress.Utils.FormatType.Numeric, "n")
        add_column_copy(gv_detail_rule, "Sales Value", "pidd_ttl_sales", DevExpress.Utils.HorzAlignment.Default, DevExpress.Utils.FormatType.Numeric, "n")
        add_column_copy(gv_detail_rule, "Next Discount", "pidd_next_disc", DevExpress.Utils.HorzAlignment.Default, DevExpress.Utils.FormatType.Numeric, "p")
        ...
        add_column_edit(gv_edit_rule, "Sales Value", "pidd_ttl_sales", DevExpress.Utils.HorzAlignment.Default, DevExpress.Utils.FormatType.Numeric, "n")
        add_column_edit(gv_edit_rule, "Next Discount", "pidd_next_disc", DevExpress.Utils.HorzAlignment.Default, DevExpress.Utils.FormatType.Numeric, "p")
    ...
    Public Overrides Function export_data() As Boolean
        ...
        Try
            ssql = "SELECT  " _
                    ...
                    & " inner join en_mstr on en_id = pi_en_id " _
                    & " inner join cu_mstr on cu_id = pi_cu_id " _
                    & " left outer join promo_mstr on promo_id = pi_promo_id " _
                    & " left outer join code_mstr on code_id = pi_sales_program " _
                    & " inner join public.pid_det on pid_pi_oid = pi_oid " _
                    & " inner join pt_mstr on pt_id = pid_pt_id " _
                    & " where pi_en_id in (0," & func_data.entity_parent(master_new.PGSqlConn.GetRowInfo("select en_id from tconfuser where userid=" _
