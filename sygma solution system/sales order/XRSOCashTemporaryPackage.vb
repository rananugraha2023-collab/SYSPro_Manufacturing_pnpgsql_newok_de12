...
Public Class XRSOCashTemporaryPackage
    ...
    Private Sub XRSOTemporary_AfterPrint(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.AfterPrint
        'set_paper()
    End Sub
            ...
            Using objcb As New master_new.WDABasepgsql("", "")
                With objcb
                    .SQL = "SELECT  " _
                            ...
                            & " and paper_en_id = " & GetCurrentColumnValue("sod_en_id").ToString _
                    ...
                    Try
                        ...
                        If _available = False Then
                            ...
                            .Command.CommandText = "INSERT INTO  " _
                                            ...
                                            & SetInteger(GetCurrentColumnValue("sod_en_id").ToString) & "," _
