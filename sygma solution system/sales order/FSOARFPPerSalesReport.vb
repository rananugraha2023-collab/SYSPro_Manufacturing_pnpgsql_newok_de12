...
Public Class FSOARFPPerSalesReport
                    ...
                    With objload
                        If xtc_master.SelectedTabPageIndex = 0 Then
                            ...
                            .SQL = "SELECT    " _
                               ...
                               & "  and so_sales_person=" & SetInteger(_ptnr_id) & " and pay_type.code_usr_1 <> '0' and left(en_desc,3) <> 'CMD' " _
                               ...
                               & "  where soship_date >= " + SetDate(pr_txttglawal.DateTime.Date) _
                               & "  and soship_date <= " + SetDate(pr_txttglakhir.DateTime.Date) _
                               & "  and so_sales_person=" & SetInteger(_ptnr_id) & " and pay_type.code_usr_1 = '0' " _
                               & "  and so_en_id in (select user_en_id from tconfuserentity " _
                                                  & " where userid = " + master_new.ClsVar.sUserID.ToString + ") " _
                               & " union all " _
                               & " SELECT    " _
