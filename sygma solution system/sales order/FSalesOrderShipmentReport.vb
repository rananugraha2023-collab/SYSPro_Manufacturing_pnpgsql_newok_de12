...
Public Class FSalesOrderShipmentReport
    ...
    Public Overrides Sub format_grid()
        ...
        add_column_copy(gv_master, "Qty SO", "sod_qty", DevExpress.Utils.HorzAlignment.Default, DevExpress.Utils.FormatType.Numeric, "n")
        add_column_copy(gv_master, "Qty Shipment", "soshipd_qty_real", DevExpress.Utils.HorzAlignment.Default, DevExpress.Utils.FormatType.Numeric, "n")
    ...
    Public Overrides Function get_sequel() As String
        get_sequel = "SELECT  " _
                    ...
                    & "  public.so_mstr.so_code,so_ref_po_code, " _
