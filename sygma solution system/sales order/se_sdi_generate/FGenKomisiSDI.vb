...
Public Class FGenKomisiSDI
    ...
    Private Sub BtGen_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BtGen.Click
        Try
            ...
            LblTotal.Text = "Total data : " & dt_fs.Rows.Count
            ...
            For Each dr As DataRow In dt_fs.Rows
                ...
                If SetNumber(_row("segend_su_sales")) = 0.0 Then
                    If _row("segend_level") = "SE" Then
                        _row("segend_komisi") = 0.0
                        _row("segend_pengali_komisi") = 0.0
                        _row("segend_komisi_bulanan") = 0.0
                        _row("segend_komisi_telah_dibayar") = 0.0
                        _row("segend_su_group") = 0.0
                        _row("segend_total_income") = 0.0
