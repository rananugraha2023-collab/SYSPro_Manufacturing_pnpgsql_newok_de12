...
Public Class XRSalesOrderShipmentLabelPrint
    ...
    Private Sub XRSalesOrderShipmentLabelPrint_AfterPrint(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.AfterPrint
        'set_paper()
    End Sub

    Private Sub XRSalesOrderShipmentLabelPrint_BeforePrint(ByVal sender As Object, ByVal e As System.Drawing.Printing.PrintEventArgs) Handles Me.BeforePrint
        xrpb_logo.Image = New Bitmap(appbase() + "\zpendukung\logo.jpg")

        Try
            XrPictureBox1.Image = QR_code.Encode(GetCurrentColumnValue("soship_code"))
            XrPictureBox2.Image = QR_code.Encode(GetCurrentColumnValue("so_code"))
            ...
            Using objcb As New master_new.WDABasepgsql("", "")
                With objcb
                    .SQL = "SELECT  " _
                            ...
                            & " and paper_en_id = " & GetCurrentColumnValue("soship_en_id").ToString _
                    ...
                    Try
                        ...
                        If _available = False Then
                            ...
                            .Command.CommandText = "INSERT INTO  " _
                                            ...
                                            & SetInteger(GetCurrentColumnValue("soship_en_id").ToString) & "," _
