...
Public Class FSalesPlanImportNew
    ...
    Private Sub FSalesPlanImportNew_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        plans_year.EditValue = DateTime.Now
    ...
    Public Overrides Function insert() As Boolean
        ...
        Try
            ...
            ssql = "INSERT INTO  " _
                ...
                & SetSetring(plans_qrtr_code_id.EditValue) & ",  " _
                & SetSetring(_plans_periodes) & ", " _
                & SetDate(plans_start_dt.DateTime) & ", " _
                & SetDate(plans_end_dt.DateTime) & ", " _
                & SetInteger(_plans_year) & ",  " _
                & SetInteger(plans_sales_id.Tag) & ",  " _
                & SetDec(_total) & ",  " _
                & SetDec(plans_target.EditValue) & ",  " _
                & SetBitYN(plans_ce_spc.EditValue) & ", " _
    ...
    Private Sub plans_qrtr_id_ButtonClick(ByVal sender As Object, ByVal e As DevExpress.XtraEditors.Controls.ButtonPressedEventArgs) Handles plans_periode.ButtonClick
