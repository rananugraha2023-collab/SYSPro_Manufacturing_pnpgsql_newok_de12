...
Public Class FSalesPlanVstControlReport
    Public func_coll As New function_collection
    Dim _now As DateTime

    Private Sub FSalesPlanVstControlReport_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        form_first_load()
    ...
    Public Overrides Sub format_grid()
        ...
        add_column_copy(gv_view1, "Visit Code", "visite_code", DevExpress.Utils.HorzAlignment.Default)
        add_column_copy(gv_view1, "Sales Person", "ptnr_name_sales", DevExpress.Utils.HorzAlignment.Default)
        add_column_copy(gv_view1, "Partner Name", "ptnr_mstr_cust", DevExpress.Utils.HorzAlignment.Default)
        add_column_copy(gv_view1, "Visit is Planned", "visite_is_planned", DevExpress.Utils.HorzAlignment.Default)
        ...
        add_column_copy(gv_view2, "Qty", "plansptd_amount", DevExpress.Utils.HorzAlignment.Default)
                    ...
                    With objload
                        If xtc_master.SelectedTabPageIndex = 0 Then
                            .SQL = "SELECT  " _
                                    ...
                                    & "  visite_enddate, " _
                                    & "  visited_ptnr_id, " _
                                    & "  ptnr_mstr_cust.ptnr_name AS ptnr_mstr_cust, " _
                                    & "  visited_date, " _
                                    & "  visited_check_in, " _
                                    & "  visited_address_gps_check_in, " _
                                    & "  visited_check_out, " _
                                    & "  visited_address_gps_check_out, " _
                                    & "  (visited_check_out - visited_check_in) as duration, " _
                                    & "  visited_visite_type, " _
                                    & "  visite_type.code_name as visite_type, " _
                                    & "  visited_visite_output, " _
                                    ...
                                    & "FROM " _
                                    & "  visite_mstr " _
                                    & "  LEFT OUTER JOIN public.plans_mstr ON (public.visite_mstr.visite_plans_oid = public.plans_mstr.plans_oid) " _
                                    & "  LEFT OUTER JOIN public.plansd_det ON (public.plans_mstr.plans_oid = public.plansd_det.plansd_plans_oid) " _
                                    & "  INNER JOIN public.en_mstr ON (public.visite_mstr.visite_en_id = public.en_mstr.en_id) " _
                                    & "  INNER JOIN ptnr_mstr ptnr_mstr_sales ON  ptnr_mstr_sales.ptnr_id = visite_sales_id " _
                                    & "  LEFT OUTER JOIN public.visited_detail ON (public.visite_mstr.visite_code = public.visited_detail.visited_visite_code) " _
                                    & "  LEFT OUTER JOIN ptnr_mstr ptnr_mstr_cust ON  ptnr_mstr_cust.ptnr_id = visited_ptnr_id " _
                                    ...
                                    & "  LEFT OUTER JOIN public.visited_sq ON (public.visite_mstr.visite_code = public.visited_sq.vsq_visite_code) " _
