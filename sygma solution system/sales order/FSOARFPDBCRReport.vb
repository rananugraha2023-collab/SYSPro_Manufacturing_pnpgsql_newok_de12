...
Public Class FSOARFPDBCRReport
                    ...
                    With objload
                        If xtc_master.SelectedTabPageIndex = 0 Then
                            ...
                            .SQL = "SELECT    " _
                               ...
                               & "  ar_date, " _
                               & "  ti_code, " _
                               & "  ti_date,pay_type.code_name as pay_type_desc " _
                               & "FROM  " _
                               ...
                               & "  and pay_type.code_usr_1 <> '0' and left(en_desc,3) not in ( 'CMD','SDI') " _
                               ...
                               & "  where soship_date >= " + SetDate(pr_txttglawal.DateTime.Date) _
                               & "  and soship_date <= " + SetDate(pr_txttglakhir.DateTime.Date) _
                               & "  and pay_type.code_usr_1 <> '0' and  left(en_desc,3)  in ( 'CMD','SDI') " _
                               & "  and so_en_id in (select user_en_id from tconfuserentity " _
