...
Public Class FPriceList
    ...
    Public Overrides Sub format_grid()
        ...
        add_column_copy(gv_master, "Is Project", "pi_is_projet", DevExpress.Utils.HorzAlignment.Default)
                ...
                With objinsert
                    ...
                    Try
                        ...
                        .Command.CommandText = "INSERT INTO  " _
                                            ...
                                            & SetBitYN(pi_is_projet.EditValue) & ",  " _
                                            & "" & SetDateNTime(master_new.PGSqlConn.CekTanggal) & "" & "  " _
                                            & ")"
    ...
    Public Overrides Function edit_data() As Boolean
        If MyBase.edit_data = True Then
            ...
            With ds.Tables(0).Rows(row)
                ...
                pi_is_projet.EditValue = SetBitYNB(.Item("pi_is_projet"))
                ...
                Using objcb As New master_new.WDABasepgsql("", "")
                    With objcb
                        .SQL = "SELECT  " _
                            ...
                            & "  where pi_oid = '" + ds.Tables(0).Rows(BindingContext(ds.Tables(0)).Position).Item("pi_oid").ToString + "'"
                ...
                With objinsert
                    ...
                    Try
                        ...
                        .Command.CommandText = "UPDATE  " _
                                            ...
                                            & "  pi_is_projet = " & SetBitYN(pi_is_projet.EditValue) & ",  " _
