Public Class FQRCodeSearch
    ...
    Private Sub fill_data()
        ...
        If fobject.name = "FPurchaseReceipt" Then
            fobject._rcv_freff_oids = ds.Tables(0).Rows(_row_gv).Item("qrcode_oid").ToString
            fobject.rcv_freff_oid.Text = ds.Tables(0).Rows(_row_gv).Item("qrcode_name")

            'fobject._rcv_treff_oids = ds.Tables(0).Rows(_row_gv).Item("qrcode_oid")
            'fobject.rcv_treff_oid.Text = ds.Tables(0).Rows(_row_gv).Item("qrcode_name")

        ElseIf fobject.name = "FInventoryReceipts" Then
            fobject._riu_freff_oids = ds.Tables(0).Rows(_row_gv).Item("qrcode_oid").ToString
            fobject.riu_freff_oid.Text = ds.Tables(0).Rows(_row_gv).Item("qrcode_name")
