...
Public Class FAddressTypeSearch
    Public _row, _en_id As Integer
    Public _is_brach As Boolean

    Private Sub FAddressTypeSearch_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        form_first_load()
        Me.Width = 371
        Me.Height = 360
        help_load_data(True)
    ...
    Public Overrides Function get_sequel() As String
        get_sequel = "select en_desc, code_id, code_code, code_name, code_desc " + _
                     ...
                     " where code_field ~~* 'addr_type_mstr'" _
                    & " and code_active ~~* 'Y'" _
    ...
    Private Sub fill_data()
        ...
        If fobject.name = "FPartnerAll" Then
            fobject.gv_edit_address.SetRowCellValue(_row, "ptnra_addr_type", ds.Tables(0).Rows(_row_gv).Item("code_id"))
            fobject.gv_edit_address.SetRowCellValue(_row, "address_type", ds.Tables(0).Rows(_row_gv).Item("code_name"))
