...
Public Class FCanvasingSearch

    Public _row As Integer
    Public _en_id As Integer
    Public _obj, _sq_sales_person As Object
    Dim func_coll As New function_collection
    Dim _now As DateTime
    Dim _conf_value As String

    Private Sub FCanvasingSearch_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        form_first_load()
    ...
    Public Overrides Sub format_grid()
        ...
        add_column(gv_master, "Cnv Number", "cnv_code", DevExpress.Utils.HorzAlignment.Default)
        add_column(gv_master, "Start Date", "cnv_start_date", DevExpress.Utils.HorzAlignment.Default)
        add_column(gv_master, "End Date", "cnv_end_date", DevExpress.Utils.HorzAlignment.Default)
        add_column(gv_master, "Sales Person", "ptnr_name", DevExpress.Utils.HorzAlignment.Default)
    ...
    Public Overrides Function get_sequel() As String
        ...
        get_sequel = "SELECT  " _
                ...
                & "  and cnv_sls_id = " + _sq_sales_person.ToString
