...
Public Class FProductStructureAssembly
                ...
                Using objcb As New master_new.WDABasepgsql("", "")
                    With objcb
                        .SQL = "SELECT en_mstr.en_desc, pt_code as codeptbom, pt_desc1 as descptbom, " _
                                ...
                                & "FROM " _
                                & "  public.pt_mstr  " _
                                & "  INNER JOIN en_mstr on pt_en_id=en_id where  pt_en_id in (0," & par_en_id & ")" _
                                & " order by pt_desc1"
    ...
    Public Overrides Sub format_grid()
        ...
        add_column_copy(gv_master, "Use BOM", "ps_use_bom", DevExpress.Utils.HorzAlignment.Default)
        add_column_copy(gv_master, "Part/BOM", "ptbomdesc", DevExpress.Utils.HorzAlignment.Default)
        add_column_copy(gv_master, "Remarks", "ps_remarks", DevExpress.Utils.HorzAlignment.Default)
        add_column_copy(gv_master, "Ratio", "ps_ratio", DevExpress.Utils.HorzAlignment.Far, DevExpress.Utils.FormatType.Numeric, "n2")
        ...
        add_column_copy(gv_detail, "Yield", "psd_yield_pct", DevExpress.Utils.HorzAlignment.Far, DevExpress.Utils.FormatType.Numeric, "p")
        ...
        add_column_edit(gv_edit, "Yield", "psd_yield_pct", DevExpress.Utils.HorzAlignment.Far, DevExpress.Utils.FormatType.Numeric, "p")
    ...
    Public Overrides Function get_sequel() As String
        ...
        get_sequel = "SELECT   " _
                    ...
                    & "   END AS ptbomdesc, ps_tran_id, ps_trans_id,tran_name,coalesce(ps_rev,0) as ps_rev " _
                    & " FROM  " _
                    & "   public.ps_mstr  " _
                    ...
                    & " where userid = " & master_new.ClsVar.sUserID.ToString & ") and ps_is_assembly='Y'"
    ...
    Private Sub gv_edit_InitNewRow(ByVal sender As Object, ByVal e As DevExpress.XtraGrid.Views.Grid.InitNewRowEventArgs) Handles gv_edit.InitNewRow
        ...
        With gv_edit
            ...
            .SetRowCellValue(e.RowHandle, "psd_qty_plan", 1)
            .SetRowCellValue(e.RowHandle, "psd_qty", 0)
            ...
            .SetRowCellValue(e.RowHandle, "psd_yield_pct", _yield)
                    ...
                    Try
                        ...
                        For i = 0 To ds_edit.Tables(0).Rows.Count - 1
                            ...
                            .Command.CommandText = "INSERT INTO  " _
                                                    ...
                                                    & SetDbl(ds_edit.Tables(0).Rows(i).Item("psd_yield_pct")) & ",  " _
                        ...
                        .Command.CommandType = CommandType.Text
                        .Command.CommandText = insert_log("Insert Product Structure Assembly " & ps_par.Text)
                        ssqls.Add(.Command.CommandText)
                        .Command.ExecuteNonQuery()
                        .Command.Parameters.Clear()
                        ...
                        sqlTran.Commit()
                        after_success()
                        set_row(Trim(_ps_oid.ToString), "ps_oid")
                        dp_detail.Visibility = DevExpress.XtraBars.Docking.DockVisibility.Visible
                        insert = True
    ...
    Public Overrides Function edit_data() As Boolean
        ...
        If MyBase.edit_data = True Then
            ...
            With ds.Tables(0).Rows(row)
                _ps_oid_mstr = .Item("ps_oid").ToString
            ...
            Using objinsert As New master_new.WDABasepgsql("", "")
                With objinsert
                    ...
                    Try
                        ...
                        .Command.CommandType = CommandType.Text
                        .Command.CommandText = insert_log("Edit Product Structure Assembly " & ps_par.Text)
                        ssqls.Add(.Command.CommandText)
                        .Command.ExecuteNonQuery()
                        .Command.Parameters.Clear()
                ...
                Using objinsert As New master_new.WDABasepgsql("", "")
                    With objinsert
                        ...
                        Try
                            ...
                            .Command.CommandType = CommandType.Text
                            .Command.CommandText = "delete from ps_mstr where ps_oid = '" + ds.Tables(0).Rows(BindingContext(ds.Tables(0)).Position).Item("ps_oid").ToString + "'"
                            ssqls.Add(.Command.CommandText)
                            .Command.ExecuteNonQuery()
                            .Command.Parameters.Clear()

                            .Command.CommandType = CommandType.Text
                            .Command.CommandText = "delete from wf_mstr where wf_ref_oid = '" + ds.Tables(0).Rows(BindingContext(ds.Tables(0)).Position).Item("ps_oid").ToString + "'"
                            ssqls.Add(.Command.CommandText)
                            .Command.ExecuteNonQuery()
                            .Command.Parameters.Clear()
                            ...
                            .Command.CommandType = CommandType.Text
                            .Command.CommandText = insert_log("Delete Product Structure Assembly " & ds.Tables(0).Rows(BindingContext(ds.Tables(0)).Position).Item("ps_par"))
                            ssqls.Add(.Command.CommandText)
                            .Command.ExecuteNonQuery()
                            .Command.Parameters.Clear()
    ...
    Public Overrides Sub approve_line()
        ...
        _oid = ds.Tables(0).Rows(BindingContext(ds.Tables(0)).Position).Item("ps_oid").ToString
        _colom = "ps_trans_id"
        _table = "ps_mstr"
        _criteria = "ps_par"
        _initial = "ps"
                        ...
                        With objinsert
                            ...
                            Try
                                ...
                                .Command.CommandText = "update ps_mstr set ps_trans_id = '" + _trans_id + "'," + _
                                               ...
                                               " ps_upd_date = current_timestamp " + _
                                               " where ps_oid = '" + ds.Tables("smart").Rows(i).Item("ps_oid").ToString + "'"
