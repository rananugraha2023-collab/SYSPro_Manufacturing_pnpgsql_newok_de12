...
Public Class FRoutingStrucTree
    Public dt_bantu As DataTable
    Public func_data As New function_data
    Public func_coll As New function_collection

    Private Sub FRoutingStrucTree_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
            ...
            Try
                Using objcb As New master_new.WDABasepgsql("", "")
                    With objcb
                        ...
                        'End If
                        If use_routing.EditValue = True Then
                            .SQL = "select a.*,invct_cost from public.get_ps_route_first(" & be_first.Tag & ",1) as a " _
