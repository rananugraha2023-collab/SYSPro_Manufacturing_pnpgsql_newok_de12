...
Public Class FWOLaborFeedbackNoUpdate
    ...
    Public Overrides Function get_sequel() As String
        DockPanel1.Visibility = DevExpress.XtraBars.Docking.DockVisibility.Visible
        get_sequel = "SELECT  " _
                & "  a.lbrf_oid,lbrf_code,lbrf_shift_id, " _
                & "  a.lbrf_dom_id, " _
                & "  a.lbrf_en_id, " _
                & "  b.en_desc,en_code, " _
                & "  a.lbrf_wodr_uid, " _
    ...
    Private Sub gv_master_SelectionChanged(ByVal sender As Object, ByVal e As DevExpress.Data.SelectionChangedEventArgs) Handles gv_master.SelectionChanged
        ...
        dt_edit = GetTableData(sSQL)
        gc_person_detail.DataSource = dt_edit
    ...
    Private Sub BtUpdate_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BtUpdate.Click
        Try
            ...
            For Each dr As DataRow In ds.Tables(0).Rows
                _code = func_coll.get_transaction_number("LB", dr("en_code"), "lbrf_mstr", "lbrf_code", dr("lbrf_date"))

                sSQL = "update lbrf_mstr set lbrf_code=" & SetSetring(_code) & " where lbrf_oid=" & SetSetring(dr("lbrf_oid"))
                DbRun(sSQL)
