...
Public Class FLabourFeedbackSummaryPrint
    ...
    Public Overrides Sub preview()
        ...
        _sql = "SELECT  " _
                ...
                & "  a.lbrf_qc_in_reason_id,dpt_lbr_cap,dpt_lbr_cap_book, " _
        ...
        Try
            With rpt
                ...
                'printTool.PreviewForm.Text = "Slip Gaji"
    ...
    Private Sub SimpleButton1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs)
        Try
            ...
            _sql = "SELECT  " _
             ...
             & " Where wo_ord_date between " & SetDate(de_first.DateTime.Date) _
             & " and  " & SetDate(de_end.DateTime.Date) _
             & " and pt_prj.pt_group=99280 group by ngroup,dpt_id "
            ...
            _sql = "SELECT  " _
                ...
                & "   LEFT outer JOIN public.dpt_mstr ON (wc_dpt_id = public.dpt_mstr.dpt_id) " _
                & " Where wo_ord_date between " & SetDate(de_first.DateTime.Date) _
                & " and " & SetDate(de_end.DateTime.Date) & " and pt_prj.pt_group=9910426 group by ngroup,dpt_id"
            ...
            _sql = "SELECT  " _
                ...
                & "   LEFT outer JOIN public.dpt_mstr ON (wc_dpt_id = public.dpt_mstr.dpt_id) " _
                & " Where wo_ord_date between " & SetDate(de_first.DateTime.Date) _
                & " and " & SetDate(de_end.DateTime.Date) & " and pt_prj.pt_group=99280  group by ngroup " _
                & " union all SELECT  " _
                ...
                & "   LEFT outer JOIN public.dpt_mstr ON (wc_dpt_id = public.dpt_mstr.dpt_id) " _
                & " Where wo_ord_date between " & SetDate(de_first.DateTime.Date) _
                & " and " & SetDate(de_end.DateTime.Date) & " and pt_prj.pt_group=9910426  group by ngroup "
