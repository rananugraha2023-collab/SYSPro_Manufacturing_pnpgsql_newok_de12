            ...
            Using objinsert As New master_new.WDABasepgsql("", "")
                With objinsert
                    ...
                    Try
                        ...
                        .Command.CommandText = "DELETE from cetak_harga_bahan  "
                        ...
                        For Each dr As DataRow In dt_edit.Rows
                            ...
                            .Command.CommandText = "INSERT INTO  " _
                                        & "  public.cetak_harga_bahan " _
                                        & "( " _
                                        & "  kode, " _
                                        & "  harga_bahan_accessories,harga_assembly_hc, " _
                                        & "  harga_assembly_jaket" _
                                        & ")  " _
                                        & "VALUES ( " _
                                        & SetSetring(dr("kode")) & ",  " _
                                        & SetDec(dr("harga_bahan_accessories")) & ",  " _
                                        & SetDec(dr("harga_assembly_hc")) & ",  " _
                                        & SetDec(dr("harga_assembly_jaket")) & "  " _
                                        & ")"
                        ...
                        .Command.CommandType = CommandType.Text
                        .Command.CommandText = insert_log("Edit Harga Bahan ")
                        ssqls.Add(.Command.CommandText)
                        .Command.ExecuteNonQuery()
                        .Command.Parameters.Clear()
