...
Public Class FHargaImposisi
    ...
    Public Overrides Sub format_grid()
        ...
        add_column_copy(gv_master, "Matras Foil", "matras_foil", DevExpress.Utils.HorzAlignment.Far, DevExpress.Utils.FormatType.Numeric, "n")
        add_column_copy(gv_master, "Matras Emboss", "matras_emboss", DevExpress.Utils.HorzAlignment.Far, DevExpress.Utils.FormatType.Numeric, "n")
        add_column_copy(gv_master, "Matras Deboss", "matras_deboss", DevExpress.Utils.HorzAlignment.Far, DevExpress.Utils.FormatType.Numeric, "n")
