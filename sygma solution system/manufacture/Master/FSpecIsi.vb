...
Public Class FSpecIsi
    ...
    Public Overrides Sub format_grid()
        add_column_copy(gv_master, "Jenis", "isi_jenis", DevExpress.Utils.HorzAlignment.Default)
        add_column_copy(gv_master, "Ukuran", "isi_ukuran", DevExpress.Utils.HorzAlignment.Default)
        add_column_copy(gv_master, "Panjang", "isi_panjang", DevExpress.Utils.HorzAlignment.Far, DevExpress.Utils.FormatType.Numeric, "n")
        add_column_copy(gv_master, "Lebar", "isi_lebar", DevExpress.Utils.HorzAlignment.Far, DevExpress.Utils.FormatType.Numeric, "n")
        add_column_copy(gv_master, "Gramasi", "isi_gramasi", DevExpress.Utils.HorzAlignment.Far, DevExpress.Utils.FormatType.Numeric, "n")
        add_column_copy(gv_master, "P", "isi_p", DevExpress.Utils.HorzAlignment.Far, DevExpress.Utils.FormatType.Numeric, "n")

        add_column_edit(gv_edit, "Jenis", "isi_jenis", DevExpress.Utils.HorzAlignment.Default)
        add_column_edit(gv_edit, "Ukuran", "isi_ukuran", DevExpress.Utils.HorzAlignment.Default)
        add_column_edit(gv_edit, "Panjang", "isi_panjang", DevExpress.Utils.HorzAlignment.Far, DevExpress.Utils.FormatType.Numeric, "n")
        add_column_edit(gv_edit, "Lebar", "isi_lebar", DevExpress.Utils.HorzAlignment.Far, DevExpress.Utils.FormatType.Numeric, "n")
        add_column_edit(gv_edit, "Gramasi", "isi_gramasi", DevExpress.Utils.HorzAlignment.Far, DevExpress.Utils.FormatType.Numeric, "n")
        add_column_edit(gv_edit, "P", "isi_p", DevExpress.Utils.HorzAlignment.Far, DevExpress.Utils.FormatType.Numeric, "n")
            ...
            Using objinsert As New master_new.WDABasepgsql("", "")
                With objinsert
                    ...
                    Try
                        ...
                        .Command.CommandText = "DELETE from cetak_spec_isi  "
                        ...
                        For Each dr As DataRow In dt_edit.Rows
                            ...
                            .Command.CommandText = "INSERT INTO  " _
                                        & "  public.cetak_spec_isi " _
                                        & "( " _
                                        & "  isi_oid,isi_jenis, " _
                                        & "  isi_ukuran,isi_panjang,isi_lebar,isi_gramasi, " _
                                        & "  isi_p" _
                                        & ")  " _
                                        & "VALUES ( " _
                                        & SetSetring(Guid.NewGuid.ToString) & "," _
                                        & SetSetring(dr("isi_jenis")) & ",  " _
                                        & SetSetring(dr("isi_ukuran")) & ",  " _
                                        & SetDec(dr("isi_panjang")) & ",  " _
                                        & SetDec(dr("isi_lebar")) & ",  " _
                                        & SetDec(dr("isi_gramasi")) & ",  " _
                                        & SetDec(dr("isi_p")) & "  " _
                                        & ")"
                        ...
                        .Command.CommandType = CommandType.Text
                        .Command.CommandText = insert_log("Edit Spec Isi ")
                        ssqls.Add(.Command.CommandText)
                        .Command.ExecuteNonQuery()
                        .Command.Parameters.Clear()
