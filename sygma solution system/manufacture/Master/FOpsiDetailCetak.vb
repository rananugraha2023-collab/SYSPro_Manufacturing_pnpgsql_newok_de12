...
Public Class FOpsiDetailCetak
    ...
    Public Overrides Sub format_grid()
        ...
        add_column_copy(gv_master, "Tipe", "tipe", DevExpress.Utils.HorzAlignment.Default)
        ...
        add_column_edit(gv_edit, "Tipe", "tipe", DevExpress.Utils.HorzAlignment.Default)
            ...
            Using objinsert As New master_new.WDABasepgsql("", "")
                With objinsert
                    ...
                    Try
                        ...
                        .Command.CommandText = "DELETE from cetak_opsi_detail_cetak  "
                        ...
                        For Each dr As DataRow In dt_edit.Rows
                            ...
                            .Command.CommandText = "INSERT INTO  " _
                                        & "  public.cetak_opsi_detail_cetak " _
                                        & "( " _
                                        & "  kode, " _
                                        & "  nilai,tipe" _
                                        & ")  " _
                        ...
                        .Command.CommandType = CommandType.Text
                        .Command.CommandText = insert_log("Edit Opsi Detail Cetak")
                        ssqls.Add(.Command.CommandText)
                        .Command.ExecuteNonQuery()
                        .Command.Parameters.Clear()
