...
Public Class FCostProject
    ...
    Private Sub FCostProject_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        form_first_load()
    End Sub
    ...
    Private Sub browse_data()
        ...
        If _col = "ukuran" Then
            Dim frm As New FUkuranBahanSearch
            frm.set_win(Me)
            frm._row = _row
            frm._pil = 3
            frm.type_form = True
            frm.ShowDialog()
        ElseIf _col = "oplagh" Then
